            ...
            <tr>
                <td align="left">
                    ...
                    <?php if ($invoice_detail->billing_street) {
                        ...
                        if (!empty($invoice_detail->billing_street_2)) {
                            echo $invoice_detail->billing_street_2 . '<br>';
                        }
                    ...
                    <tr class="border-bottom-blank-td">
                        <td class="text-left" width="30%">
                            <?php if ($property_street_array && is_array($property_street_array) && !empty($property_street_array) ) {
                                ...
                                if (!empty($invoice_detail->property_street_2)) {
                                    echo $invoice_detail->property_street_2 . '<br>';
                                }
            ...
            if (isset($invoice_detail) && is_array($invoice_detail) && !empty($invoice_detail) ) {
                ...
                if ($invoice_detail->report_id != 0) {
                    ...
                    $products[]= array(
                        ...
                        'report'=>isset($invoice_details->report_details) ? $invoice_details->report_details : isset($invoice_detail->report) ? $invoice_detail->report : '',
                    );
                } else {
                    array_push($report_id, $job->jobs[0]['job_report']->report_id);
                    $products[] = array(
