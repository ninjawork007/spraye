                        ...
                        <div class="">
                            ...
                            <div class="col-md-6 register-form" style="min-height: 497px;padding: 70px;">
                                ...
                                <div class="panel panel-white register-form text-center">
                                    ...
                                    <?php  
                                        // if (($basys_details && $purchase_order_details->status!=3) || ($cardconnect_details && $purchase_order_details->status!=3)) { 
                                        if (($basys_details) || ($cardconnect_details)) { ?>

                                        <tr class="button-tr" >
                                                <td></td>  
                                                <td></td>  
                                                <!-- <td class="text-left" colspan="4" ><button class="btn btn-success"><a href="<?= base_url('Welcome/estimatePayment/').base64_encode($purchase_order_details->estimate_id)  ?>" target="_blank" >Pay Now</a></button></td> -->
                                    ...
                                    <?php 
                                        // } elseif ($setting_details->pay_now_btn==1 && $setting_details->pay_now_btn_link!='' && $estimate_details->status!=3) { 
                                        } elseif ($setting_details->pay_now_btn==1 && $setting_details->pay_now_btn_link!='' && $estimate_details->status!=3) { ?>
                                           <tr class="button-tr" >
                                                <td></td>  
                                                <td></td>  
