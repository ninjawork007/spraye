                            ...
                            <table class="table table-condensed">
                                    ...
                                    foreach ($invoice_detail->all_sales_tax  as  $invoice_sales_tax_details) {
                                        ...
                                        <tr>
                                            ...
                                            <td class="border-bottom-blank-td text-right">$
                                                ...
                                                <?php $tax_amm = $invoice_total_cost * ($invoice_sales_tax_details['tax_value'] / 100);
                                                if ($invoice_sales_tax_details['tax_value'] != 0) {
                                                    $invoice_total_cost += $tax_amm;
                                                } ?>
                                                <?= number_format($tax_amm, 2);  ?>
                                            </td>
                                        </tr>
                                <?php }
                                } ?>
                                ...
                                <?php if ($cardconnect_details && $invoice_detail->payment_status != 2) { ?>
                                    ...
                                    <tr class="button-tr">
                                        <td></td>
                                        <td></td>
                                        <td class="text-left" colspan="4"><button class="btn btn-success"><a href="<?= base_url('Welcome/cardConnectPayment/') . base64_encode($invoice_detail->invoice_id)  ?>" target="_blank">Pay Now</a></button>
                                        </td>
                                ...
                                <?php } elseif ($basys_details && $invoice_detail->payment_status != 2) { ?>
                                    ...
                                    <tr class="button-tr">
                                        <td></td>
                                        <td></td>
                                        <td class="text-left" colspan="4"><button class="btn btn-success"><a href="<?= base_url('Welcome/payment/') . base64_encode($invoice_detail->invoice_id)  ?>" target="_blank">Pay Now</a></button>
                                        </td>
                                        <td class="text-right"></td>
                                ...
                                <?php } elseif ($setting_details->pay_now_btn == 1 && $setting_details->pay_now_btn_link != '' && $invoice_detail->payment_status != 2) { ?>
                                    <tr class="button-tr">
                                        <td></td>
                                        <td></td>
                                        <td class="text-left" colspan="4"><button class="btn btn-success"><a href="<?= $setting_details->pay_now_btn_link  ?>" target="_blank">Pay Now</a></button>
                                        </td>
                                        <td class="text-right"></td>
                            ...
                            <table width="100%" class="table table-condensed inside-tabel mannual application_tbl" style="font-size:10px;" cellspacing="0">
                                <thead>
                                    ...
                                    <tr class="default-font-color">
                                        <td class="default-font-color">DATE Hi & TIME</td>
                                    ...
                                    <td>
                                        <table width="100%" class="table table-condensed inside-tabel mannual application_tbl" style="font-size:12px;" cellspacing="0">
                                            <thead class="border-bottom">
                                                <tr>
                                                    <td class="border-bottom default-font-color" align="center">APPLICATOR'S NAME</td>
                                                    <td class="border-bottom default-font-color" align="center">APPLICATOR'S NUMBER</td>
                                                    <td class="border-bottom default-font-color" align="center">APPLICATOR'S PHONE</td>
                                                    <td class="border-bottom default-font-color" align="center">WIND SPEED</td>
                                                    <td class="border-bottom default-font-color" align="center">TEMP</td>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
