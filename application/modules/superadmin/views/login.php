        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content pb-20">
                    ...
                    <form action="<?= base_url('superadmin/auth') ?>" method="POST" name="adminlogin" class="form-validate">
                  <!--    <div class="panel panel-body login-form" style="background-color: transparent;border: 0;border-radius: 0;">
                        ...
                        <div class="panel panel-body login-form login_new" style="background: #01669a;color: #fff;">Super Admin Login</div>
                        ...
                        <div class="panel panel-body login-form">
                          ...
                          <!--   <div class="text-center">
                            ...
                            <div class="col-sm-12 text-right">
                                        New User? <a href="#" class="signup_bg_link">Sign Up Here</a>
                                    </div>
                            </div>  -->       
                           <!--  <div class="form-group">
