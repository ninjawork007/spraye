            ...
            <div class="panel-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                     ...
                     <!--   <select class="bootstrap-select form-control" data-live-search="true" name="customer_id" id="customer_id" readonly>
              ...
              <div class="row">
               ...
               <div class="col-md-6">
                ...
                <div class="col-md-6">
                 ...
                 <!--    <select class="bootstrap-select form-control" data-live-search="true" name="program_id">
              ...
              <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="col-lg-9" style="padding-left: 4px;padding-right: 4px;">
                      ...
                      if($invoice_details->payment_status==0){
                        ...
                        <select class="form-control" name="payment_status" id="invoice_payment_status" >
                          ...
                          <!-- <option value="4"  <?php if ($invoice_details->payment_status==4) { echo "Selected";} ?> >Refund</option> -->
                          </select>
                 ...
                 $total_amount = $total_actual_cost;
               ...
               <div class="row">
                      ...
                      <div class="form-group"  style="margin-bottom: 35px;">
                        ...
                        <div class="col-lg-9" style="padding-left: 4px;padding-right: 1px;">
                            ...
                            <span class="input-group-btn">
                              ...
                              <input type="text" class="form-control" name="over_all_total" id="over_all_total" placeholder="Enter Cost" value="<?=  number_format($totat_amount,2, '.', '') ?>" readonly  >
                            </div>
                        </div>
                      </div>
                </div> -->
                ...
                <!-- <?php 
                 ...
                 $totat_amount =  $invoice_details->cost  +  $total_tax_amount ;
                 $totat_amount = $total_actual_cost;
                 $due_amount = $totat_amount - $invoice_details->partial_payment; 
                 $due_amount = $due_amount < 0 ? 0 : $due_amount;
                 ?> -->
              <!-- SALES TAX DISCOUNT ROW -->
              <div class="row">
                <!-- if (isset($invoice_total_tax) && !empty($invoice_total_tax)) { -->
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <div class="col-lg-9" style="padding-left: 0;padding-right: 0;" >
                        <div class="input-group">  
                          ...
                          <input type="text" class="form-control" name="" id="" placeholder="Enter Partial payment" value="<?php if (isset($invoice_total_tax) && !empty($invoice_total_tax)) { echo number_format($invoice_total_tax,2, '.', ''); } else { echo 0; } ?>" readonly >     
                        </div>
                    </div>
                  </div>
                </div>
                ...
                <?php } ?>
                  ...
                  foreach ($all_invoice_partials as $key=>$invoice_partial_payment) {
                    ...
                    <!-- <form style="display: none;">
                      <label class="control-label new_label_control" style="font-size: 17px; margin-left: 5px; display: none;">
                        Refund Amount
                      </label>
                    </form> -->
                    ...
                    <div class="form-group">
                        ...
                        <!-- <div class="col-lg-9" style="padding-left: 0;padding-right: 0;" >
                            <div class="input-group">  
                              ...
                              <small style="color: red; margin-left: 50px; display: none;" id="partial_payment_new_msg">please insert a valid non-zero number</small>                  
                        </div> -->
                            ...
                            ?>
                              <div class="col-lg-9" style="padding-left: 0;padding-right: 0;" >
                                  <div class="input-group">  
                                    ...
                                    <!-- <a data-toggle="modal" data-target="#modal_theme_primary_partial_payment_total_full_full" style="position: absolute; margin-top: 0px; margin-left: 10px; z-index: 999;"><button class="btn btn-warning" type="button" id="full_refund">Refund</button></a> -->
                                  </div>
                              </div>
                              <?php } else { ?>
                                <div class="col-lg-9" style="padding-left: 0;padding-right: 0;" >
                    ...
                    <div class="multi-select-full col-lg-8  col-sm-10 col-xs-10" style="padding-left: 4px;">
                      <select class="multiselect-select-all-filtering form-control" name="assign_coupons[]" id="" multiple="multiple">
                        <?php foreach ($customer_one_time_discounts as $value): ?>
                             <option value="<?= $value->coupon_id ?>" <?php if(in_array($value->coupon_id, $existing_coupon_invoice )) { ?>selected <?php  } ?>   > <?= $value->code ?> </option>
                        <?php endforeach ?>
                      </select>
                    </div>
                  </div>
      ...
      <div class="modal-content">
        ...
        <form 
          ...
          name="refund_total_full" method="post" style="padding: 10px;" >
            ...
            <input type="hidden" name = "payment_log_id" value="<?=$invoice_partial_payment->payment_invoice_logs_id?>"> 
            <!-- <input type="hidden" name = "partial_payment" value="<?=$invoice_details->partial_payment?>"> -->
              <div class="modal-body">
              <div class="form-group">
                  <div class="row">
                    <div class="col-sm-6 col-md-6">
                        ...
                        <!-- <select id="refund_type_full_full" class="form-control required" name="payment_type" style="border: 1px solid #12689b; margin-top: 5px;"> 
            ...
            <div class="modal-footer">
              <!-- <button type="submit" class="btn btn-success" onclick="refund_full_payment_log(<?=$invoice_partial_payment->payment_invoice_logs_id?>)"  >Refund</button> -->
...
<div id="modal_theme_primary_paid_payment" class="modal fade">
	<div class="modal-dialog">
        ...
        <h6 class="modal-title">Pay Total Amount Due</h6>
          ...
          <input type="text" class="form-control" name="partial_payment" value="<?= number_format($due_amount,2, '.', '') ?>" readonly>
          <input type="hidden" name="invoice_id" value="<?= $invoice_details->invoice_id ?>">
          <input type="hidden" name="payment_status" value="2">
          <input type="hidden" name="total_due" value="<?= number_format($due_amount,2, '.', '') ?>">
          <div style="height: 10px;"></div>
...
//     // localStorage.setItem("invoice_payment_status", $(this).val());
//     if ($(this).val() == '0') {
//       $("#partial_payment").hide()
//       $("#total_due_payment").hide()
//       $("#full_refund").hide()
...
$(document).ready(function() {
    // alert($('#invoice_payment_status').val());
    console.log('Payment Status: onload ', $('#invoice_payment_status').val());
//     var payment_status = <?php $invoice_details->payment_status ?>;
...
//       $("#total_due_payment").hide();
//       $("#full_refund").hide();
//       $("#invoice_payment_status [value='1']").hide();
//     }
//     });
//     // $( "div" ).text( str );
//   }).change();
...
$('.partial_button').click(function() {
  // $("select[name=payment_status] option:selected ").val('1').trigger('change');
...
// salesTaxDetails("<?= $invoice_details->property_id ?>")
...
$(document).on("change","#invoice_payment_status",function (argument) {
  ...
  function manageBalance(argument) {
         ...
         var cost = Number('<?php echo $total_actual_cost ?>');
