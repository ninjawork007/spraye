												...
												<?php
													if ($potential_job_coupon->coupon_amount_calculation == 0) {
														?>
															...
															<td class="text-left" width="30%"><?= $potential_job_coupon->coupon_code ?></td>
														...
														?>
															<td class="text-left" width="20%">DISCOUNT</td>
															<td class="text-left" width="30%"><?= $potential_job_coupon->coupon_code ?> (-<?= $potential_job_coupon->coupon_amount ?>%)</td>
															<td class="text-left" width="10%"></td>
															<td class="text-left" width="10%">
														<?php
				...
				<?php } ?>
					<tr>
						  <td colspan="2" class="paid_logo cl_50">
							...
							<!-- <img class="logo" src="<?= base_url('assets/customers/assets/images/paid.png') ?>"> -->
							<?php }   ?>
						  <td colspan="3" class="cl_50">
							...
							<table class="table table-condensed">
								  <tr>
									...
									<!-- <td class="border-bottom-blank-td text-right">$ <?= number_format($invoice_details->cost,2) ?></td> -->
												...
												<td></td>
													<?php
														if ($coupon_details->amount_calculation == 0) {
															echo '<td class="border-bottom-blank-td text-left default-font-color">'.$coupon_details->code.'</td><td class="border-bottom-blank-td text-right">';
															...
															echo '<td class="border-bottom-blank-td text-left default-font-color">'.$coupon_details->code.' (-'.$percentage.'%)</td><td class="border-bottom-blank-td text-right">';
					...
					<tr>
						<td></td>
                        <td></td>
                        <td class="text-left" colspan="4"><p class="button_tr"><a href="<?=base_url("/customers/dashboard/").$invoice_details->customer_id; ?>" target="_blank"><strong><?php echo 'Access Your Account' ?></strong></a></p></td>
                        <td class="text-right"></td>
					</tr>
							...
							<table width="100%" class="table table-condensed inside-tabel mannual application_tbl" style="font-size:10px;" cellspacing="0">
								  <thead>
									<tr class="first_tr" style="text-transform:uppercase;">
										<td colspan="5" valign="middle">&nbsp;&nbsp;APPLICATION & PRODUCT DETAILS</td>
