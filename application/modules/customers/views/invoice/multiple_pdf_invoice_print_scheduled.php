		...
		<table width="100%" class="table table-condensed" style="margin: -10px 0 20px 0;" id="paystub-table">
            <tr class="first_tr">
              <td align="left" width="50%" style="padding: 5px 20px 5px 5px!important;">
                <b>CUSTOMER</b> <p style="float: right;margin:0px;"><?= $invoice_detail->first_name.' '.$invoice_detail->last_name ?></p>
              </td>
			...
			<tr>
				<td align="left" width="50%" style="padding-right: 20px;">
					<b>Invoice Date</b>
					<p style="float:right; margin:0px;"><?php echo  date("m/d/Y" ,strtotime( $invoice_detail->invoice_date)) ?></p>
					<div style="height: 1px; width: 100%; background-color: #E3E3E3; margin-top: 10px;"></div>
				</td>
			</tr>
			<tr>
          ...
          <td colspan="2" class="cl_50">
            ...
            <table class="table table-condensed" >
              ...
              <tr>
                ...
                <td class="border-bottom-blank-last text-right" style="text-align:right;">$ <?= number_format($invoice_total_cost,2);?></td>
              </tr>
