...
<html lang="en">
    ...
    <head>
        ...
        <script language="JavaScript">          
            ...
            // var expir = document.getElementById('ccexpirymonth');
            // expir.addEventListener('input', function(event){
            //     console.log("Expiration Month: " + expir);
            //     console.log("Expiration Month: " + expir.value);
            // });
    ...
    <body class="login-container" style="overflow: hidden;">
        ...
        <div class="page-container">
                    ...
                    <div class="content pb-20">
                        ...
                        <div class="login-form">
                            <center>
                                ...
                                <?php } else { ?> -->
                                <img src="<?= base_url() ?>/assets/customers/image/Spraye_Logo_Web_White.png " alt="">
                                <!-- <?php  }  ?> -->
                            ...
                            <div class="form-group login-options">
                                <div class="row">
                                    ...
                                    <span class="text-center no-margin">Total Amount :
                                        ...
                                        <?=$setting_details->company_currency?>
                                    </span>
            ...
            $('#tokenform').on('submit', function(e) {
                ...
                setTimeout(function(){
                    $.ajax({
                    url: '<?php echo base_url('customers/Welcome/ccPaymentProcess'); ?>',
                    type: 'POST',
                    data: {
                        requestData: {
