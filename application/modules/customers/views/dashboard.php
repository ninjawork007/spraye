                ...
                <div class="form-group">
                    <div class="row">
                        <div class="col-md-12">
                                    ...
                                    <div class="col-md-6 col-xs-6 pay-buttons ">
                                        ...
                                        if (isset($due_invoices) && !empty($due_invoices)) {
                                            ...
                                            <?php if ($cardconnect_details) { ?>
                                                <a href="<?= base_url('customers/Welcome/paymentTotal/') . base64_encode($o_string) ?>"
                                                   target="_blank">
                                                    <button type="button"
                                                            class="btn  btn-paid-status due_payment portal_btn"
                                                            id="payCloverBalance"
                                            ...
                                            <?php } else if ($basys_details) { ?>
                                                <button type="button" class="btn btn-paid-status due_payment portal_btn"
                                                        id="payBasysBalance"
                                    ...
                                    <div class="col-md-6 col-xs-6 pay-buttons">
                                        ...
                                        if (isset($past_due_invoices) && !empty($past_due_invoices)) {
                                            ...
                                            <p class="card-text" style="color:red;">
                                                $ <?= number_format($total_past_due, 2, '.', '') ?>  </p>
                                            <?php
                                            if (isset($past_due_invoices) && !empty($past_due_invoices)) {
                                                $pass_in_array = [];
                                                ...
                                                if ($cardconnect_details) {
                                                    ?>
                                                    <a href="<?= base_url('customers/Welcome/paymentPastDue/') . base64_encode($p_string) ?>"
                                                       target="_blank">
                                                        <button type="button"
                                                                class="btn btn-danger past_due_payment portal_btn"
                                                                id="cloverPastDue"
                            ...
                            <div class="form-group col-md-3 col-xs-12 go-to-customer"
                                ...
                                <div class="col-md-10 col-xs-10" style="min-width:200px;">
                                    <select class="bootstrap-select form-control" data-live-search="true"
                                            name="go_to_property" id="go_to_account">
                                        <?php if (!empty($all_customers)) {
                                            foreach ($all_customers as $key => $value) { ?>
                                                <option
                                                    value="<?php echo $value->customer_id; ?> " <?php echo ($customerData['customer_id'] == $value->customer_id) ? 'selected' : ''; ?>><?php echo $value->first_name . ' ' . $value->last_name . ' - ' . $value->customer_company_name ?></option>
                                ...
                                <div class="col-md-2 col-xs-2">
                                    <button class="btn btn-primary" onclick="goToAccount()" id="go_to_account_btn">Go
                                    </button>
                                </div>
                            </div>
                        </div>
            ...
            <div class="tabbable">
                <ul class="nav nav-tabs nav-tabs-solid nav-justified">
                    ...
                    <li class="lione <?php echo $active_nav_link == '1' ? 'active' : '' ?> "><a
                            href="#highlighted-justified-tab1" data-toggle="tab">Billing Info</a></li>
                    <li class="litwo <?php echo $active_nav_link == '2' ? 'active' : '' ?>"><a
                            href="#highlighted-justified-tab2" data-toggle="tab">My Services</a></li>
                    ...
                    <li class="lifour <?php echo $active_nav_link == '4' ? 'active' : '' ?>"><a
                            href="#highlighted-justified-tab4" data-toggle="tab">My Properties</a></li>
                </ul>
                ...
                <div class="tab-content">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-12">
                                        <div class="table-responsive table-spraye dash-tbl">
                                            <table class="table dataTable" id="outstandingInvoices" role="grid">
                                                ...
                                                <tr role="row">
                                                    <th colspan="5"
                                                        style="text-align: center; border-top:1px solid #6eb1fd;"><?php echo '<a href="#highlighted-justified-tab3" data-toggle="tab" onclick="openTab(\'lithree\')">View All</a>' ?></th>
                                                </tr>
                                                </tfoot>
                                            </table>
                                        </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-12">
                                        <div class="table-responsive table-spraye dash-tbl">
                                            <table class="table dataTable" id="scheduledServices" role="grid">
                                                ...
                                                <tr role="row">
                                                    <th colspan="3"
                                                        style="text-align: center; border-top:1px solid #6eb1fd;"><?php echo '<a href="#highlighted-justified-tab2" data-toggle="tab" onclick="openTab(\'litwo\')">View All</a>' ?></th>
                                                </tr>
                                                </tfoot>
                                            </table>
                                        </div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-12">
                                        <div class="table-responsive table-spraye dash-tbl">
                                            <table class="table dataTable" id="assignedPrograms" role="grid">
                                                ...
                                                <tr role="row">
                                                    <th colspan="3"
                                                        style="text-align: center; border-top:1px solid #6eb1fd;"><?php echo '<a href="#highlighted-justified-tab4" data-toggle="tab" onclick="openTab(\'lifour\')">View All</a>' ?></th>
                                                </tr>
                                                </tfoot>
                                            </table>
                                        </div>
                    ...
                    <div class="tab-pane <?php echo $active_nav_link == '1' ? 'active' : '' ?>"
                        ...
                        <form class="form-horizontal" action="<?= base_url('customers/updateCustomer') ?>" method="post"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div id="CustomerSubscribeTooltip" class="checkbox"
                                                            ...
                                                            <label class="checkbox-inline checkbox-right">
                                                                <input id="CustomerSubscribeButton" type="checkbox"
                                                                       name="is_email"
                                                                       class="switchery-is-email" <?php echo $customerData['is_email'] == 1 ? 'checked' : '' ?> >
                                                                Subscribe
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    if ($setting_details->is_text_message == 1) {
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="checkbox">
                                                                ...
                                                                <input name="is_mobile_text" id="mobile_text"
                                                                       type="checkbox" class="switchery-is-mobile-text"
                                                                    <?php echo $customerData['is_mobile_text'] == 1 ? 'checked' : ''; ?>

                                                                >
                                                                <label class="togglebutton" style="font-size:13px">Sign
                                                                    up for text alerts</label>
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <select class="form-control" name="billing_state" id="region">
                                                    ...
                                                    <optgroup label="Canadian Provinces">
                                                        <option
                                                            value="AB" <?php if ($customerData['billing_state'] == 'AB') {
                                                            echo "selected";
                                                        } ?> >Alberta
                                                        </option>
                                                        <option
                                                            value="BC" <?php if ($customerData['billing_state'] == 'BC') {
                                                            echo "selected";
                                                        } ?> >British Columbia
                                                        </option>
                                                        <option
                                                            value="MB" <?php if ($customerData['billing_state'] == 'MB') {
                                                            echo "selected";
                                                        } ?> >Manitoba
                                                        </option>
                                                        <option
                                                            value="NB" <?php if ($customerData['billing_state'] == 'NB') {
                                                            echo "selected";
                                                        } ?> >New Brunswick
                                                        </option>
                                                        <option
                                                            value="NF" <?php if ($customerData['billing_state'] == 'NF') {
                                                            echo "selected";
                                                        } ?> >Newfoundland
                                                        </option>
                                                        <option
                                                            value="NT" <?php if ($customerData['billing_state'] == 'NT') {
                                                            echo "selected";
                                                        } ?> >Northwest Territories
                                                        </option>
                                                        <option
                                                            value="NS" <?php if ($customerData['billing_state'] == 'NS') {
                                                            echo "selected";
                                                        } ?> >Nova Scotia
                                                        </option>
                                                        <option
                                                            value="NU" <?php if ($customerData['billing_state'] == 'NU') {
                                                            echo "selected";
                                                        } ?> >Nunavut
                                                        </option>
                                                        <option
                                                            value="ON" <?php if ($customerData['billing_state'] == 'ON') {
                                                            echo "selected";
                                                        } ?> >Ontario
                                                        </option>
                                                        <option
                                                            value="PE" <?php if ($customerData['billing_state'] == 'PE') {
                                                            echo "selected";
                                                        } ?> >Prince Edward Island
                                                        </option>
                                                        <option
                                                            value="QC" <?php if ($customerData['billing_state'] == 'QC') {
                                                            echo "selected";
                                                        } ?> >Quebec
                                                        </option>
                                                        <option
                                                            value="SK" <?php if ($customerData['billing_state'] == 'SK') {
                                                            echo "selected";
                                                        } ?> >Saskatchewan
                                                        </option>
                                                        <option
                                                            value="YT" <?php if ($customerData['billing_state'] == 'YT') {
                                                            echo "selected";
                                                        } ?> >Yukon Territory
                                                        </option>
                                                    </optgroup>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label class="control-label col-lg-3">Sign up for Auto Pay
                                                    <label class="togglebutton" style="font-size:13px">Do you want us to
                                                        run your credit card automatically upon job completion? <span
                                                            data-popup="tooltip-custom"
                                                            title="When this option is on, your credit card on file will be charged when a service is completed. Your invoice will then automatically be marked as paid."
                                                            data-placement="top"> <i
                                                                class=" icon-info22 tooltip-icon"></i> </span></label></label>
                                                <div class="col-lg-4">
                                                    <label class="togglebutton" style="font-size:13px">Off</label>
                                                    <?php if ($cardconnect_details && $cardconnect_details->status != 0) { ?>
                                                        <input name="clover_autocharge" type="checkbox"
                                                               class="switchery-autocharge" id="switchery-autocharge"
                            ...
                            <div class="text-right">
                                <button type="submit" class="btn btn-success">Submit Changes <i
                                            ...
                                            <td>
                                                <ul style="list-style-type: none; padding-left: 0px;">
                                                    ...
                                                    <li style="display: inline; padding-right: 10px;">
                                                        <a href="<?= base_url('admin/invoices/printInvoice/') . $value->invoice_id ?>"
                                                           target="_blank" class=" button-next"><i
                                                                class="bi-credit-card position-center"
                                                                style="color: #9a9797;"></i></a>
                                                    </li>
                                                    <li style="display: inline; padding-right: 10px;">
                                                        <a href="<?= base_url('customers/Welcome/payment/') . base64_encode($value->invoice_id) ?>"
                                                           target="_blank">
...
<div id="text_msg_alert" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="add_text_alert" id="add_text_alert" method="POST" enctype="multipart/form-data"
                  form_ajax="ajax">
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="modal-body" id="text_alerts_modal">
                                    ...
                                    <strong><?= $setting_details->company_name ?></strong> in order to update you about
                                    your upcoming and completed services. You may receive up to 4 messages per service
                                    scheduled. Message and data rates may apply to all messages received. You are not
                                    required to receive these messages as a condition of receiving services from
                                    <strong><?= $setting_details->company_name ?></strong>. If you have any questions
                                    about these text messages, you can reach out to us at
                                    <strong><?= $setting_details->company_email ?></strong>. You can opt out of these
                                    text message updates at any time by replying ‘STOP’ to any message or unchecking the
                                    option in my customer account.
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" onclick="TextMessageOff()" data-dismiss="modal">
                            Close
                        </button>
                        <button type="submit" id="submitTextAlert" name="accept" value="1" class="btn btn-success"
                                data-customer="<?= $customerData['customer_id'] ?>">I Accept
                        </button>
                    </div>
                </div>
            </form>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="modal-body" id="clover_on_modal">
                                    You have set Auto-Pay to ON. The credit card on file with Clover Connect will
                                    automatically run on job completion. To save these settings, click "Submit Changes".
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            <div class="col-sm-12 col-md-12">
                                <div class="modal-body" id="basys_on_modal">
                                    You have set Auto-Pay to ON. The credit card on file with Basys will automatically
                                    run on job completion. To save these settings, click "Submit Changes".
                                </div>
                            </div>
                        </div>
                    </div>
...
<div id="auto_off" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="auto_off_modal" id="auto_off_modal" method="POST" enctype="multipart/form-data"
                  form_ajax="ajax">
                <div class="modal-body">
                    <div class="form-group">
                        <div class="row">
        ...
        <div class="modal-content">
            ...
            <form name="add_clover_payment" id="add_clover_payment" method="POST" enctype="multipart/form-data"
                ...
                <div class="modal-body">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-danger" onclick="AutoPayOff()" data-dismiss="modal">Close
                        </button>
...
<div id="modal_generate_statement" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content" style="height: 305px;">
            ...
            <form method="POST"
                  action="<?= base_url('customers/invoices/getOpenInvoiceByCustomer/') . $customerData['customer_id'] ?>"
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <button class="btn btn-warning" type="submit"><i class=" icon-file-pdf"></i> Generate Statement
                        </button>
                    </div>
                </div>
...
<div id="modal_add_secondary_emails" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="add_secondary_email" id="my_form"
                  action="<?= base_url('customers/addSecondaryEmailDataJson') ?>" method="post"
...
<div id="modal_add_property" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form name="addproperty" id="my_form2" action="<?= base_url('customers/addPropertyDataJson') ?>"
                  method="post" enctype="multipart/form-data" form_ajax="ajax">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-4 col-sm-4">
                                <label>Address</label>
                                <input type="text" class="form-control" name="property_address" id="autocomplete2"
                                       onFocus="geolocate()" placeholder="Address" onkeydown="keydownAddress2()">
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input type="text" class="form-control" name="property_address_2"
                                       id="property_address_2" placeholder="Address 2">
                            </div>
                            <div class="col-md-6 col-sm-6">
                                <label>City</label>
                                <input type="text" class="form-control" name="property_city" id="locality2"
                                       placeholder="City">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input type="text" class="form-control" id="postal-code2" name="property_zip"
                                ...
                                <select class="form-control" name="property_area"
                                    ...
                                    <?php if (!empty($propertyarealist)) {
                                        ...
                                        foreach ($propertyarealist as $value) { ?>
                                            <option
                                                value="<?= $value->property_area_cat_id ?>"><?= $value->category_area_name ?></option>
                                        <?php }
                                    } ?>
                                </select>
                            </div>
                                    ...
                                    <select class="multiselect-select-all-filtering form-control"
                                        ...
                                        <?php if (!empty($sales_tax_details)) {
                                            foreach ($sales_tax_details as $key => $value) {
                                                ?>
                                                <option
                                                    value="<?= $value->sale_tax_area_id ?>"><?= $value->tax_name ?>  </option>
                                            <?php }
                                        } ?>
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input type="text" class="form-control" name="yard_square_feet" id="yard_square_feet"
                                       placeholder="Yard Square Feet">
                            </div>
                            <div class="col-md-6 col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input type="text" class="form-control" name="front_yard_square_feet"
                                       id="front_yard_square_feet" placeholder="Front Yard Square Feet">
                            </div>
                            <div class="col-md-6 col-sm-6">
                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6">
                                ...
                                <input type="text" class="form-control" name="back_yard_square_feet"
                                       id="back_yard_square_feet" placeholder="Back Yard Square Feet">
                            </div>
                            <div class="col-md-6 col-sm-6">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-12 col-sm-6">
                                ...
                                <div class="multi-select-full">
                                    <select class="multiselect-select-all-filtering form-control"
                                            name="assign_program[]" multiple="multiple" id="program_list"
                                            value="<?php echo set_value('assign_program') ?>">

                                        <?php foreach ($programlist as $value) : ?>
                                            <option
                                                value="<?= $value->program_id ?>"><?= $value->program_name ?></option>
                                        <?php endforeach ?>
                                    </select>
                                </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form id="pastDue_payment_form" method="post" style="padding: 10px;">
                ...
                <label class="control-label new_label_control" style="font-size: 17px; margin-left: 5px;">Total Amount
                    Past Due:</label>
                <input type="text" class="form-control" name="partial_payment"
                       value="<?= number_format($total_past_due, 2, '.', '') ?>" readonly>
                <input type="hidden" name="payment_status" value="3">
                <input type="hidden" name="total_due" value="<?= number_format($total_due, 2, '.', '') ?>">
                <div style="height: 10px;"></div>
                <select class="bootstrap-select form-control" name="payment_method" id="paid_modal_select"
                        style="border: 1px solid #12689b; margin-top: 5px;">
                ...
                <div style="height: 10px;"></div>
                <label class="control-label new_label_control" style="font-size: 17px; margin-left: 5px;">Payment
                    Info:</label>
