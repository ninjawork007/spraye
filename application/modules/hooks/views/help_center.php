                                ...
                                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                                    ...
                                    <tr>
                                        <td class="content-cell">
                                            <h1>Hi Admin,</h1>
                                            <p>You recently get the help request. Use the below info.                                               
                                            </p>
                                            <!-- Action -->
                                 
                                            <p><span>Name </span>{{name}}</p>
                                             <p><span>Email </span>{{email}}</p>
                                              <p><span>Important Type </span>{{important_type}}</p>    
                                               <p><span>Message Type </span>{{message_type}}</p>
                                                <p><span>Subject </span>{{subject}}</p>
                                                <p><span>Message </span>{{message}}</p>

                                            
                                            <p>Thanks,
                                                <br>The Daddy Pocket Team</p>
                                            <!-- Sub copy -->
