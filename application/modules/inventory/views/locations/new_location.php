			...
			<div class="px-2 mt-n1 col">
				<div class="section">
					...
					<div class="content-item">
							<form  action="<?= base_url('inventory/Backend/Locations/create') ?>" method="post" id="add_new_location" name="addnewlocation" enctype="multipart/form-data" >
							<div class="row mt-0">
								<!-- Left -->
								...
								<div class="col-md-6 text-break pl-2 pr-2">
									...
									<div class="form-group">
										...
										<input type="text" name="location_street" id="location_street" class="form-control" />
									</div>
									...
									<div class="form-row">
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" id="location_zip" name="location_zip" class="form-control" />
											</div>
										</div>
					...
					<input type="hidden" name ="sub_location_fleet_no" id="sub_location_fleet_no" value = "0">
					<div class="form-group">
						<div class="row">
						...
						<div class="table-responsive">
							<table id="sub_location" class="table table-striped table-bordered table-hover">
								...
								<tbody id='sublocation'>
									...
									<tr>
										<td id="sub_name" name ="sub_location_name_id[]" value="" ></td>
