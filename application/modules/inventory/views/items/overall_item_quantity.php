   ...
   <div class="panel-body">
      ...
      <div id="itemtablediv">
         <div  class="table-responsive table-spraye">
            <table class="table" id="overall_item_quantity">
               <thead>
                  <tr>
                        <th>Item Name</th>
                        <th>Total Units on Hand</th>
                  </tr>
               </thead>
               <input type="hidden" id="quants" value="<?php echo $quant_str; ?>">
            </table>
         </div>
      </div>
   </div>
...
<div id="modal_choose_subloc" class="modal fade">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header bg-primary" style="background: #36c9c9;border-color: #36c9c9;">
        <button type="button" class="close" data-dismiss="modal">&times;</button>
        <h6 class="modal-title">Choose Sub-Location</h6>
      </div>
...
<script type="text/javascript">
   $(document).ready(function(){
	...
	// console.log("Ajax Call");
	 ...
	 var table =  $('#overall_item_quantity').DataTable({
		   "processing": true,
		   "serverSide": true,
		   "paging":true,
		    "pageLength":100,
			"order":[[0,'asc']],
		   "ajax":{
		     "url": "<?= base_url('inventory/Frontend/Items/ajaxGetOverallItemQuantity')?>",
		     "dataType": "json",
		     "type": "POST",
		   ...
		   "columns": [
                ...
                {"data": "quantity", "name": "Total Units On Hand", "orderable": true, "searchable": false}
		       ],
		   language: {
