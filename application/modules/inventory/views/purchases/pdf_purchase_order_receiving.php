    ...
    <body>
        ...
        <div class="container">
            ...
            <table width="100%" class="table table-condensed">
                <tr class="first_tr">
                    <td><strong>PURCHASE ORDER NO: # <?=$purchase_receiving->purchase_order_number?></strong></td>
                    <td align="center"> Ordered by: <strong><?= $purchase_receiving->name ?></strong></td>
                    <td align="right"> <strong><?=Date("m/d/Y", strtotime($purchase_receiving->created_at))?></strong></td>
                </tr>
            </table>
            <table width="100%" class="table table-condensed" style="margin-bottom: 20px;">
                ...
                <tr>
                    <td align="left" width="33%">
                        <table width="100%">
                            <tr>
                                <td><?= $purchase_receiving->vendor_name ?></td>
                            </tr>
                            <tr>
                                <td><?= $purchase_receiving->vendor_street_address ?></td>
                            </tr>
                            <tr>
                                <td><?= $purchase_receiving->vendor_city . ', ' . $purchase_receiving->vendor_state . ', ' .
                                    $purchase_receiving->vendor_zip_code; ?></td>
                            </tr>
                            <tr>
                                <td><?= $purchase_receiving->company_name?></td>
                            </tr>
                            <tr>
                                <td><?= formatPhoneNum($purchase_receiving->vendor_phone_number) ?></td>
                            </tr>
                            <tr>
                                <td><?= $purchase_receiving->vendor_email_address?></td>
                            </tr>
                        </table>
                    ...
                    <td align="left" width="33%">
                        ...
                        <table width="100%">
                            <tr>
                                <td><?= $purchase_receiving->location_name ?></td>
                            </tr>
                            <tr>
                                <td><?= $purchase_receiving->location_street ?></td>
                            </tr>
                            <tr>
                                <td><?= $purchase_receiving->location_city . ', ' . $purchase_receiving->location_state . ', ' .
                                    $purchase_receiving->location_zip; ?></td>
                            </tr>
                            <tr>
                                <td><?= formatPhoneNum($purchase_receiving->location_phone) ?></td>
                            </tr>
                        </table>
                    </td>
            ...
            <table width="100%" class="table table-condensed main_table" cellspacing="0">
                ...
                <tbody>
                    <?php 
                        ...
                        $items = json_decode($purchase_receiving->items, true);
                        if ($items) {
                    ...
                    <tr>
                        ...
                        <td class="text-right" style="text-align: right; padding-right: 16px;">
                         <?php
                            // $line_total += $cost;
                            $line_total += round(($value['received_qty']*$value['unit_price'] ), 2);
                            // echo '$   ' . number_format(($line_total), 2);
                            ?>
                            <?='$   ' . number_format(($value['received_qty']*$value['unit_price'] ), 2) ?>
                        </td>
                    </tr>
            ...
            <table width="100%" class="main_table none_border" style="border: 1px solid #ddd;">
                ...
                <tr style="" class="th-head">
                    ...
                    <td style="border-right: none; border-bottom: 1px solid #ddd !important;" class="text-center"
                        width="10%"><strong><?=number_format($purchase_receiving->discount, 2)?></strong>
                    </td>
                </tr>
                <tr style="" class="th-head">
                    <td style="border-right: none; border-bottom: 1px solid #ddd !important; text-align: right;"
                    ...
                    <td style="border-right: none; border-bottom: 1px solid #ddd !important;" class="text-center"
                        width="10%"><strong><?=number_format($purchase_receiving->freight, 2)?></strong>
                    </td>
                </tr>
                <?php 
                    $discount = number_format($purchase_receiving->discount, 2);
                    $total_discounted = $line_total - $discount;
                    $shipping_cost = number_format($purchase_receiving->freight, 2);
                    $pretax_total = $total_discounted + $shipping_cost;
                   
                    $line_tax_amount = $pretax_total  * $purchase_receiving->tax/ 100;

                ?>
                <tr style="" class="th-head">
                    <td style="border-right: none; border-bottom: 1px solid #ddd !important; text-align: right;"
                        class="text-right" width="80%"><strong>Tax
                            <?php echo "(" . $purchase_receiving->tax . "%)"; ?></strong>
                    </td>
                    <td style="border-right: none; border-bottom: 1px solid #ddd !important; text-align: right;"
                        class="text-right" width="10%"><strong>$</strong>
                    </td>
                ...
                <?php 
                    ...
                    // $taxed_total = $pretax_total * $purchase_receiving->tax/ 100;
