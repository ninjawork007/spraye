            ...
            <table width="100%" class="table table-condensed" style="margin-bottom: 20px;">
                ...
                <tr>
                    <td align="left" width="33%">
                        <table width="100%">
                            <tr>
                                <td><?= $purchase_return->vendor_name ?></td>
                            </tr>
                            <tr>
                                <td><?= $purchase_return->vendor_street_address ?></td>
                            </tr>
                            <tr>
                                <td><?= $purchase_return->vendor_city . ', ' . $purchase_return->vendor_state . ', ' .
                                    $purchase_return->vendor_zip_code; ?></td>
                            </tr>
                            <tr>
                                <td><?= $purchase_return->company_name?></td>
                            </tr>
                            <tr>
                                <td><?= formatPhoneNum($purchase_return->vendor_phone_number) ?></td>
                            </tr>
                            <tr>
                                <td><?= $purchase_return->vendor_email_address?></td>
                            </tr>
                        </table>
                    ...
                    <td align="left" width="33%">
                        ...
                        <table width="100%">
                            <tr>
                                <td><?= $purchase_return->location_name ?></td>
                            </tr>
                            <tr>
                                <td><?= $purchase_return->location_street ?></td>
                            </tr>
                            <tr>
                                <td><?= $purchase_return->location_city . ', ' . $purchase_return->location_state . ', ' .
                                    $purchase_return->location_zip; ?></td>
                            </tr>
                            <tr>
                                <td><?= formatPhoneNum($purchase_return->location_phone) ?></td>
                            </tr>
                        </table>
                    </td>
            ...
            <table width="100%" class="table table-condensed main_table" cellspacing="0">
                ...
                <tbody>
                    <?php 
                        ...
                        $items = json_decode($purchase_return->items, true);
                        if ($items) {
                    ...
                    <tr>
                        ...
                        <td class="text-right" style="text-align: right; padding-right: 16px;">
                         <?php
                            // $line_total += $cost;
                            $line_total += round(($value['return_qty']*$value['unit_price'] ), 2);
                            // echo '$   ' . number_format(($line_total), 2);
                            ?>
                            <?='$   ' . number_format(($value['return_qty']*$value['unit_price'] ), 2) ?>
                        </td>
                    </tr>
            ...
            <table width="100%" class="main_table none_border" style="border: 1px solid #ddd;">
                ...
                <tr style="" class="th-head">
                    ...
                    <td style="border-right: none; border-bottom: 1px solid #ddd !important;" class="text-center"
                        width="10%"><strong><?=number_format($purchase_return->discount, 2)?></strong>
                    </td>
                </tr>
                <tr style="" class="th-head">
                    <td style="border-right: none; border-bottom: 1px solid #ddd !important; text-align: right;"
                    ...
                    <td style="border-right: none; border-bottom: 1px solid #ddd !important;" class="text-center"
                        width="10%"><strong><?=number_format($purchase_return->freight, 2)?></strong>
                    </td>
                </tr>
                <?php 
                    $discount = number_format($purchase_return->discount, 2);
                    $total_discounted = $line_total - $discount;
                    $shipping_cost = number_format($purchase_return->freight, 2);
                    $pretax_total = $total_discounted + $shipping_cost;
                   
                    $line_tax_amount = $pretax_total  * $purchase_return->tax/ 100;

                ?>
                <tr style="" class="th-head">
                    <td style="border-right: none; border-bottom: 1px solid #ddd !important; text-align: right;"
                        class="text-right" width="80%"><strong>Tax
                            <?php echo "(" . $purchase_return->tax . "%)"; ?></strong>
                    </td>
                    <td style="border-right: none; border-bottom: 1px solid #ddd !important; text-align: right;"
                        class="text-right" width="10%"><strong>$</strong>
                    </td>
                ...
                <?php 
                    ...
                    // $taxed_total = $pretax_total * $purchase_return->tax/ 100;
