        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content pb-20">                            
                    ...
                    <form action="<?= base_url('technician/auth') ?>" method="POST" name="adminlogin" class="form-validate">
                  <!--    <div class="panel panel-body login-form" style="background-color: transparent;border: 0;border-radius: 0;">
                        ...
                        <div class="panel panel-body login-form login_new" style="background: #01669a;color: #fff;">Technician Login</div>
                        ...
                        <div class="panel panel-body login-form">
                          ...
                          <!--   <div class="text-center">
                            ...
                            <div class="form-group has-feedback has-feedback-left">
                                ...
                                <input type="text" class="form-control" placeholder="Email" name="email" required="required"  value="<?php if(isset($_COOKIE["loginTechId"])) { echo $_COOKIE["loginTechId"]; } ?>" >
                            ...
                            <div class="form-group has-feedback has-feedback-left">
                                ...
                                <input type="password" class="form-control" placeholder="Password" name="password" required="required" value="<?php if(isset($_COOKIE["loginTechPass"])) { echo $_COOKIE["loginTechPass"]; } ?>" >
                                ...
                                <div class="row">
                                    <div class="col-sm-6">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" class="styled" name="remember" <?php if(isset($_COOKIE["loginTechId"])) { ?> checked="checked" <?php } ?> >
                                            Remember Me
                                        </label>
                                    </div>
                            ...
                            <div class="row" > 
                                 <div class="col-md-6 col-sm-12 text-left">
                                     <a href="<?= base_url('technician/auth/forgetPassword') ?>" >Forgot password?</a>
                                </div> 
