        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content pb-20">                             
                    ...
                    <form action="<?= base_url('technician/auth/forgetPassword') ?>" method="POST" name="adminlogin" class="form-validate">
                  <!--    <div class="panel panel-body login-form" style="background-color: transparent;border: 0;border-radius: 0;">
                        ...
                        <div class="panel panel-body login-form login_new" style="background: #01669a;color: #fff;">Technician Forgot Password</div>
                            ...
                            <div class="form-group login-options">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 text-center">
                                         <a href="<?= base_url('technician/auth') ?>" > Login as Technician</a>
