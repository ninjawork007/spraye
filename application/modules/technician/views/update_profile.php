        ...
        <div class="content">
         ...
         <div class="panel-heading">
            ...
            <div class="panel-body">              
              ...
              <form class="form-horizontal" action="<?= base_url('technician/updateProfileData') ?>" method="post" name="adduser" enctype="multipart/form-data">
...
<br>
                <div class="row">
                  <div class="col-md-12">
                    <div class="form-group">
                      <center>
                        <input type="file" id="user_pic"  name="user_pic" class="file" >
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <div class="col-lg-9">
                        ...
                        <input type="text" class="form-control" name="applicator_number" readonly="" placeholder="Applicator Number" value="<?= $user_details->applicator_number ?>">
