...
<div class="content">
            ...
            <table cellspacing="5" cellpadding="5" width="100%">
                <tr>
                    <td>
                        <table width="100%">
                            <tr>
                                <td style="padding-left:10px"><h5 class="text-semibold"
                                                                  style="margin:0px;"><?= $job_assign_details[0]['first_name'] . ' ' . $job_assign_details[0]['last_name'] ?></h5>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-left:10px">
                                    <h7 class="text-muted"><?php if (isset($job_assign_details[0]['phone']) && !empty($job_assign_details[0]['phone'])) {
                                            echo "<a href='tel:'" . $job_assign_details[0]['phone'] . "'>" . preg_replace("/^1?(\d{3})(\d{3})(\d{4})$/", "($1) $2-$3", $job_assign_details[0]['phone']) . "</a>";
                                        } ?></h7>
                                </td>
                            </tr>
                            <tr>
                                <td style="padding-left:10px">
                                    <h7 class="text-muted"><?= $property_details->property_address ?></h7>
                                </td>
                            </tr>
                            <tr>
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12" style="background-color: #e6e6e6 !important">
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="tecnician-btn" style="padding-bottom: 10px !important;">
                        <a class="btn btn-technician btn-property"
                           href="<?= base_url('technician/editProperty/') . $job_assign_details[0]['property_id'] ?>"
                           id="save" class="btn btn-success"><i class=" icon-arrow-left7"> </i> Edit Property
                            Details</a>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="tecnician-btn" style="padding-bottom: 10px !important;">
                        <a class="btn btn-technician btn-estimate "
                           href="<?= base_url('technician/Estimates/addEstimate/') . $job_assign_details[0]['property_id'] ?>"
                           id="" class="btn btn-warning"><i class=" icon-file-pdf"> </i> Create Estimate</a>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="tecnician-btn" style="padding-bottom: 10px !important;">
                        <button type="button" class="btn btn-primary btn-technician btn-pay " id="updatePayment"
                                data-target="<?php if ($cardconnect_details && $cardconnect_details->status != 0) { ?>  #clover_payment_method <?php } else if ($basys_details && $basys_details->status != 0) { ?> #basys_payment_method <?php } ?>"
                                data-toggle="modal" <?php if (!$job_assign_details) { ?> disabled <?php } else if (!$cardconnect_details && !$basys_details) { ?> disabled <?php } else if ($customerData['clover_autocharge'] == 1 || $customerData['basys_autocharge'] == 1) { ?> disabled <?php } ?> >
                            <i class=" icon-plus22"></i> Setup Autopay
                        </button>
                        <div class="col-lg-4">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="panel-group panel-group-control panel-group-control-right content-group-lg"
                 id="accordion-control-right-top" style="padding-top: 10px !important;">
                <div class="panel panel-white">
                    <div class="panel-heading">
                        <h6 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion-control-right-top"
                               href="#accordion-control-right-group" aria-expanded="false" class="collapsed"
                               style="font-size:18px;">Service Details</a>
                        </h6>
                    </div>
                    <div id="accordion-control-right-group" class="panel-collapse collapse" aria-expanded="false"
                         style="height: 0px;">
                            ...
                            <div class="panel panel-white">
                                <div class="panel-heading">
                                    <h5 class="panel-title text-semibold">
                                        <a data-toggle="collapse" data-parent="#accordion-control-right-group"
                                           href="#accordion-control-right-group1-<?= $i ?>" aria-expanded="false"
                                           class="collapsed"><?= $service['job_details']->job_name ?></a>
                                    </h5>
                                </div>
                                <div id="accordion-control-right-group1-<?= $i ?>" class="panel-collapse collapse"
                                        ...
                                        <div class="panel-heading">
                                            <h6 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse"
                                                   data-parent="#accordion-control-right-group1-<?= $i ?>"
                                                   href="#accordion-control-right-group2-<?= $i ?>"
                                                   aria-expanded="false">Product Details</a>
                                            </h6>
                                        </div>
                                        <div id="accordion-control-right-group2-<?= $i ?>"
                                                ...
                                                <div class="table-responsive" style="min-height:inherit;">
                                                    ...
                                                    <table class="table" style="border: 0 !important">
                                                        <tr style="background-color: #F5F5F5;">
                                                            ...
                                                            <td><h6 class="text-semibold">Mixture Application Rate</h6>
                                                            </td>
                                    ...
                                    <div class="panel panel-white">
                                        <div class="panel-heading">
                                            <h6 class="panel-title">
                                                <a class="collapsed" data-toggle="collapse"
                                                   data-parent="#accordion-control-right-group1"
                                                   href="#accordion-control-right-group3-<?= $i ?>"
                                                   aria-expanded="false">Program Details</a>
                                            </h6>
                                        </div>
                                        <div id="accordion-control-right-group3-<?= $i ?>"
                                             class="panel-collapse collapse" aria-expanded="false">
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="panel-group panel-group-control panel-group-control-right content-group-lg"
                 id="accordion-control-right-top2" style="padding-top: 10px !important;">
                <div class="panel panel-white">
                    <div class="panel-heading">
                        <h6 class="panel-title">
                            <a class="collapsed" data-toggle="collapse" data-parent="#accordion-control-right-top2"
                               href="#accordion-control-right-group2" aria-expanded="false" style="font-size:18px;">Yard
                                Information/Notes</a>
                        </h6>
                    </div>
                    <div id="accordion-control-right-group2" class="panel-collapse collapse" aria-expanded="false">
                        <?php if (!empty($property_details)) { ?>
                            <table class="table" style="border: 0 !important">
                                <tr>
                                    <td><h6 class="text-semibold">Total Yard Square
                                            Feet: </h6><?= $property_details->yard_square_feet / 1000 ?> K sq. ft.
                                    </td>
                                    <?php if (!empty($property_details->front_yard_square_feet)) { ?>
                                        <td><h6 class="text-semibold">Front Yard Square
                                                Feet: </h6><?= $property_details->front_yard_square_feet / 1000 ?> K sq.
                                            ft.
                                        </td>
                                    <?php } ?>
                                    <?php if (!empty($property_details->back_yard_square_feet)) { ?>
                                        <td><h6 class="text-semibold">Back Yard Square
                                                Feet: </h6><?= $property_details->back_yard_square_feet / 1000 ?> K sq.
                                            ft.
                                        </td>
                                    <?php } ?>
                                </tr>
                                <tr>
                                    <?php if (!empty($property_details->total_yard_grass)) { ?>
                                        <td><h6 class="text-semibold">Total Yard Grass
                                                Type: </h6><?= $property_details->total_yard_grass ?></td>
                                    <?php } ?>
                                    <?php if (!empty($property_details->front_yard_grass)) { ?>
                                        <td><h6 class="text-semibold">Front Yard Grass
                                                Type: </h6><?= $property_details->front_yard_grass ?></td>
                                    <?php } ?>
                                    <?php if (!empty($property_details->back_yard_grass)) { ?>
                                        <td><h6 class="text-semibold">Back Yard Grass
                                                Type: </h6><?= $property_details->back_yard_grass ?></td>
                                    <?php } ?>
                                </tr>
                                <tr>
                                    <td><h6 class="text-semibold">Property
                                            Info: </h6><?= $property_details->property_notes ?></td>
                                </tr>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="panel-group panel-group-control panel-group-control-right content-group-lg"
                 id="accordion-control-right-top3" style="padding-top: 10px !important;">
                <div class="panel panel-white">
                    <div class="panel-heading">
                        <h6 class="panel-title">
                            <a data-toggle="collapse" data-parent="#accordion-control-right-top3"
                               href="#accordion-control-right-group3" aria-expanded="false" class="collapsed"
                               style="font-size:18px;">Service History</a>
                        </h6>
                    </div>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="panel-group panel-group-control panel-group-control-right content-group-lg"
                 id="accordion-control-right-top4" style="padding-top: 10px !important;">
                <div class="panel panel-white">
                    <div class="panel-heading">
                        <h6 class="panel-title">
                            <a class="collapsed" data-toggle="collapse" data-parent="#accordion-control-right-top4"
                               href="#accordion-control-right-group4" aria-expanded="false" style="font-size:18px;">Property
                                Conditions</a>
                        </h6>
                    </div>
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    ...
                                    <?php if (!empty($property_conditions)) { ?>
                                        <?php foreach ($property_conditions as $condition) { ?>
                                            <div class="btn btn-primary property-condition-button"
                                                 id="prop_cond_<?= $condition->property_condition_assign_id ?>">
                                                <?= $condition->condition_name ?>
                                                <button type="button" class="close removePropertyConditionClose"
                                                        aria-label="Close"
                                                        onclick="removePropertyCondition(<?= $condition->property_condition_assign_id ?>)">
    ...
    <?php if (!empty($job_assign_details[0]['email']) && $job_assign_details[0]['is_email'] == 1) { ?>
        <div class="row">
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="panel-group panel-group-control panel-group-control-right content-group-lg"
                     id="accordion-control-right-top5" style="padding-top: 10px !important;">
                    <div class="panel panel-white">
                        <div class="panel-heading">
                            <h6 class="panel-title">
                                <a class="collapsed" data-toggle="collapse" data-parent="#accordion-control-right-top5"
                                   href="#accordion-control-right-group5" aria-expanded="false" style="font-size:18px;">Message
                                    to Customer</a>
                            </h6>
                        </div>
                        <div id="accordion-control-right-group5" class="panel-collapse collapse" aria-expanded="false">

                            <form action="<?= base_url('technician/SendCustomerEmail') ?>" id="sendemail" method="post"
                                  name='customeremail'>

                                <table class="table" style="border: 0 !important">
                                    <tr>
                                        <td><h5 class="text-semibold"><input type="text" name="email"
                                                                             class="form-control" readonly=""
                                                                             value="<?= $job_assign_details[0]['email'] ?>">
                                            </h5></td>
                                    </tr>

                                    <tr>
                                        <td><textarea class="form-control" placeholder="Enter Your Message" rows="5"
                                                      name="message"></textarea></td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <button type="submit" id="sendmsgbt" class="btn btn-success text-right">
                                                Send
                                            </button>
                                        </td>
                                    </tr>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="panel-group panel-group-control panel-group-control-right content-group-lg"
                 id="accordion-control-right-top6" style="padding-top: 10px !important;">
                <div class="panel panel-white">
                    <div class="panel-heading">
                        <h6 class="panel-title">
                            <a class="collapsed" data-toggle="collapse" data-parent="#accordion-control-right-top6"
                               href="#accordion-control-right-group6" aria-expanded="false" style="font-size:18px;">Internal
                                Customer/Property Notes</a>
                        </h6>
                    </div>
                    <div id="accordion-control-right-group6" class="panel-collapse collapse" aria-expanded="false">
                        ...
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-sm-12">
                                <div class="panel-group panel-group-control panel-group-control-right content-group-lg"
                                     id="accordion-control-right-top6-1" style="padding-top: 10px !important;">
                                    <div class="panel panel-white">
                                        <div class="panel-heading"
                                             style="background-color:#e6e6e6!important;padding-left:10px;padding-right:10px;">
                                            <h6 class="panel-title">
                                                <button class="collapsed btn btn-technician" data-toggle="collapse"
                                                        data-parent="#accordion-control-right-top6-1"
                                                        href="#accordion-control-right-group6-2" aria-expanded="false"
                                                        style="background: #0190d9; border: none;">Create New Note
                                                </button>
                                            </h6>
                                        </div>
                                        <div id="accordion-control-right-group6-2" class="panel-collapse collapse"
                                             aria-expanded="false">

                                            <!-- Form Start -->
                                            <form class="form-horizontal"
                                                  action="<?= base_url('technician/createNote'); ?>" method="post"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xs-12 assignservicesedicustumer"
                                                         id="assignservicesedicustumer">
                                                        <div class="form-group">
                                                            <label class="control-label col-lg-3">Assign
                                                                Services</label>
                                                            <div class="col-lg-9">
                                                                <select class="form-control"
                                                                        name="note_assigned_services">
                                                    ...
                                                    <div class="col-xs-12 assignservicesedicustumer">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <select class="form-control"
                                                                        name="assigned_service_note_duration">
                                                                    <option value="">None</option>
                                                    ...
                                                    <div class="col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input id="note_due_date" type="date"
                                                                       name="note_due_date"
                                                ...
                                                <div class="row row-extra-space">
                                                    <div class="col-xs-12">
                                                        <div class="form-group">
                                                            <label class="control-label col-lg-3">Attach
                                                                Documents</label>
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <input type="checkbox"
                                                                       onchange="toggle_notification_to();"
                                                ...
                                                <div class="row">
                                                    <div class="col-xs-12 toggle_notification_to" style="display: none">
                                                        <div class="form-group">
                                                            <label class="col-lg-3">
                                                                Notification To
                                                            </label>
                                                            <div class="multi-select-full col-lg-9">
                                                                <select
                                                                    class="multiselect-select-all form-control note-filter"
                                                                    name="notification_to[]" id="notification_to"
                                                                    multiple="multiple">
                                                                    <?php
                                                                    foreach ($userdata as $user) {
                                                                        ?>
                        ...
                        if (!empty($enhanced_notes)) {
                            foreach ($enhanced_notes as $note) {
                                if ($note->include_in_tech_view) {
                                    ?>
                                    <div
                                        class="well note-element<?= ($note->note_category == 0) ? ' property-note' : ' customer-note' ?>"
                            ...
                            <span class="dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown"
                              ...
                              <i class="icon-menu" aria-hidden="true"></i>
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-right"
                                                        ...
                                                        <li class="dropdown-header text-bold text-uppercase">Actions
                                                        </li>
                                                        ...
                                                        <li class="dropdown-menu-item text-muted dropdown-menu-item-icon<?= ($note->note_status == 2 || $currentUser->id !== $note->note_assigned_user && $currentUser->id !== $note->note_user_id) ? ' disabled' : ''; ?>">
                                                            <a href="<?= base_url('technician/markNoteComplete/') . $note->note_id; ?>"><i
                                                                    class="fa fa-check-square-o" aria-hidden="true"></i>Mark
                                                                Complete</a></li>
                                                        <li class="dropdown-menu-item text-muted dropdown-menu-item-icon<?= ($note->note_status == 2 || $currentUser->id !== $note->note_assigned_user && $currentUser->id !== $note->note_user_id) ? ' disabled' : ''; ?>">
                                                            <a href="<?= base_url('technician/toggleUrgentMarker/') . $note->note_id . '/' . ($note->is_urgent ? 0 : 1); ?>"><i
                                                                    class="fa fa-check-square-o" aria-hidden="true"></i><?= $note->is_urgent ? 'Remove Urgent Status' : 'Mark Urgent'; ?></a>
                                                        </li>
                                                        <li class="dropdown-menu-item text-muted dropdown-menu-item-icon<?= ($currentUser->id !== $note->note_assigned_user && $currentUser->id !== $note->note_user_id) ? ' disabled' : ''; ?>">
                                                            <a href="<?= base_url('technician/deleteNote/') . $note->note_id; ?>"><i
                              ...
                              ?>
                                                    ...
                                                    <div class="form-group hidden"
                                                        ...
                                                        <label class="control-labe col-xs-12 col-lg-3">Assign
                                                            User</label>
                                        ...
                                        <div class="row hidden note_edit_notification_to_<?= $note->note_id;?>">
                                            ...
                                            <div class="multi-select-full col-lg-3">
                                                <select class="multiselect-select-all form-control note-filter"
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group hidden"
                                                    ...
                                                    <select class="form-control col-sm-12" name="note_edit_type"
                                        ...
                                        <div class="row note-footer note-footer-flex">
                                            <div class="col-xs-12 col-md-7 note-footer-left">
                                                <div class="row">
                                                    ...
                                                    <div
                                                        class="col-xs-6 col-md-8 note-due-date text-warning text-uppercase text-bold text-right">
                                                        DUE: <i
                                                            id="note-duedate-<?= $note->note_id; ?>"><?= ($note->note_due_date != '0000-00-00' && !empty($note->note_due_date)) ? $note->note_due_date : 'None Set'; ?></i><input
                                                            id="note_due_date_<?= $note->note_id; ?>" type="date"
                                                            name="note_due_date"
                                        ...
                                        <?= $note->user_first_name; ?> <?= $note->user_last_name; ?>
                                                    ...
                                                    if (isset($note->property_address) && isset($note->property_city)) {
                                                        ?>
                                                        <div
                                                            class="customer-address col-xs-12 col-md-8 col-lg-6 text-bold text-muted">
                                                            <?= $note->property_address; ?>
                                                            , <?= $note->property_city; ?>
                                                        </div>
                                                        <?php
                                                    }
                                            ...
                                            <div class="col-xs-12 col-md-4 note-footer-right">
                                                <div class="row">
                                                    <div
                                                        class="col-xs-6 col-md-6 note-comments text-left note-ico-btns">
                                                        <i class="icon-bubble btn-ico" aria-hidden="true"
                                                    ...
                                                    <div
                                                        class="col-xs-6 col-md-6 note-attachments text-right note-ico-btns">
                                                        <i class="icon-attachment btn-ico" aria-hidden="true"
                                                           data-toggle="collapse"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    ...
                                                    <ul class="list-group comments-list-group">
                                                        ...
                                                        <?php } ?>
                                                        <li class="list-group-item comment-list-item">
                                                            <form action="<?= base_url('technician/addNoteComment') ?>"
                                                                ...
                                                                <input type="hidden" value="<?= $note->note_id; ?>"
                                                                       name="comment-noteid">
                                                                <input type="hidden" value="<?= $note->note_type; ?>"
                                                                       name="comment-notetype">
                                        ...
                                        <div class="note-files collapse" id="note-files-<?= $note->note_id; ?>">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-3">
                                                    <i class="icon-cloud-upload btn-ico" aria-hidden="true"
                                                       data-toggle="collapse"
                                                       data-target="#note-fileupload-<?= $note->note_id; ?>"
                                                       aria-expanded="false"
                                                       aria-controls="note-fileupload-<?= $note->note_id; ?>"></i>
                                                </div>
                                                <div class="col-xs-12 collapse"
                                                     id="note-fileupload-<?= $note->note_id; ?>">
                                                    <form action="<?= base_url('technician/addToNoteFiles'); ?>"
                                                                ...
                                                                if ($ext == 'pdf') { ?>
                                                                    <div class="col-xs-6 col-md-2 text-center">
                                                                        ...
                                                                        <a href="<?= CLOUDFRONT_URL . $file->file_key; ?>"
                                                                           target="_blank">
                                                                            <i class="icon-file-text2 file-attach-icon"
                                                                               aria-hidden="true"></i>
                                                                        </a>
                                                                    </div>
                                                                <?php } else { ?>
...
<!--- COMPLETE JOB FORM --->
<div id="modal_mixture_application" class="modal fade" data-backdrop="static"
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="<?= base_url('technician/completeJobMultiple/') . $tech_assign_ids ?>" name="completejobform"
                  method="post" enctype='multipart/form-data' id="job_completion_form">
                <input type="hidden" name="prog_price" id="prog_price"
                       value=<?= $job_assign_details[0]['program_price'] ?>>
                <input type="hidden" name="is_group_billing" id="is_group_billing"
                       value=<?= $job_assign_details[0]['billing_type'] ?>>
                <input type="hidden" name="next_service_only_note_ids" id="next_service_only_note_ids"
                       value="<?= $next_service_only_note_ids ?>">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            foreach ($service['product_details_dif'] as $key => $value) {
                                ...
                                <div id="<?= $service['job_details']->job_id . '_' . $value->product_id ?>"
                                     class="col-sm-6 col-md-6" style="margin: 7px 0; <?= $hidden ?>">
                    ...
                    <div class="form-group" id="add_product_div_<?= $service['job_details']->job_id ?>"
                         style="display: none">
                        <div class="row" style="margin-left: 2%">
                            <div class="col-4">Select Product:</div>
                            <div class="col-8">
                                <div class="multi-select-full col-lg-8  col-sm-10 col-xs-10">
                                    <select class="multiselect-select-all form-control"
                                            id="add_product_select_<?= $service['job_details']->job_id ?>"
                                            class="multiselect-select-all product-select" multiple="multiple"
                    ...
                    <div class="form-group">
                        <div class="row">
                            <a id="add_product_link_<?= $service['job_details']->job_id ?>"
                               onclick='show_selec_products("<?= $service['job_details']->job_id ?>")'
                               style="margin-left: 2%"> + Add product</a>
                        </div>
                    </div>
        ...
        if ($job_assign_details[0]['is_email'] == 1) { ?>
            ...
            <div class="form-group">
                <div class="row">
                    ...
                    <div class="multi-select-full col-md-12">
                        ...
                        <select class="multiselect-select-all form-control" name="property_conditions[]"
                                multiple="multiple" id="property_conditions_list">
                            <?php if (isset($propertyconditionslist)) {
                                ...
                                foreach ($propertyconditionslist as $condition) {
                                    if (in_array($condition->property_condition_id, $selectedpropertyconditions)) { ?>
                                        <option value="<?php echo $condition->property_condition_id; ?>"
                                                selected><?php echo $condition->condition_name; ?></option>
                                    <?php } else { ?>
                                        $
                                        <option
                                            value="<?php echo $condition->property_condition_id; ?>"><?php echo $condition->condition_name; ?></option>
                                    <?php } ?>
            ...
            <hr>
            <h6 class="text-semibold">Type a message to the customer below to be included with the Service completion
                email.</h6>
...
<script type="text/javascript"
        src="<?= base_url('assets/technician') ?>/assets/js/plugins/forms/styling/uniform.min.js"></script>
<script type="text/javascript"
        src="<?= base_url('assets/technician') ?>/assets/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
...
<script>
    ...
    function updateAssignUser(userId, noteId, userName) {
        $.post("<?= base_url('technician/updateAssignUser'); ?>", {
            'noteId': noteId,
            'userId': userId
        }, function (result) {
    ...
    function updateAssignType(typeId, noteId, typeName, match) {
        $.post("<?= base_url('technician/updateAssignType'); ?>", {
            'noteId': noteId,
            'typeId': typeId
        }, function (result) {
    ...
    function updateNoteDueDate(el) {
        ...
        let dueDate = $(el).val();
        if (dueDate != '') {
            $.post("<?= base_url('technician/updateNoteDueDate'); ?>", {
                'noteId': noteId,
                'dueDate': dueDate
            }, function (result) {
    ...
    function changeNoteNotificationTo(e, id) {
        ...
        $.ajax({
            url: "<?= base_url('technician/updateNoteNotificationTo') ?>",
            data: {
                note_id: id,
