...
<div class="content">
  ...
  <div class="panel panel-flat">
        ...
        <h5 class="panel-title">
          <div class="form-group">
            <div class="row">
              <div class="col-md-12">
                <div class="btndiv">
                  <a href="<?= base_url('technician/jobDetails/').$propertyData['property_id'] ?>" id="save" class="btn btn-success"><i class="icon-arrow-left7"></i> Back to Route</a>

                  <a href="<?= base_url('technician/Estimates/addEstimate/') . $propertyData['property_id'] ?>" id="" class="btn btn-warning"><i class="icon-plus2"> </i> Create Estimate</a>
                  <!-- <a href="<?= base_url('technician/Estimates/addEstimate?pr_id=') . $propertyData['property_id'] ?>" id="" class="btn btn-warning"><i class="icon-plus2"> </i> Create Estimate</a> -->
    ...
    <div class="panel-body">
      ...
      <form class="form-horizontal" action="<?= base_url('technician/updateProperty') ?>" method="post" name="addproperty" enctype="multipart/form-data">
                      ...
                      if (!empty($selectedprogramlist)) {
                        ...
                        foreach ($selectedprogramlist as $value) {
                          ...
                          echo '<tr id="trid' . $value->program_id . '" >
                                      ...
                                      <td><input type="number" name="tmp' . $n . '" min="0" step="0.01" value="' . $price_override . '"  class="inpcl form-control" optval="' . $value->program_id . '"  ></td>                                                 
          ...
          <div class="form-group">
            ...
            <div class="row">
              <div class="col-sm-12">
                ...
                <input type="number" class="form-control" min="0" step="0.01" name="add_job_price_override" value="">
              </div>
            </div>
          </div>
...
<script type="text/javascript">
          ...
          if (optionValue != '') {
            ...
            if ($.inArray(optionValue, selectedValues) != '-1') {
              ...
              var $row = $('<tr id="trid' + optionValue + '">' +
                '<td>' + optionText + '</td>' +
                '<td> <input type="number" name="tmp' + $n + '" min="0"  step="0.01" class="inpcl form-control" optval="' + optionValue + '"  ></td>' +
                '</tr>');
  ...
  $('form[name="addService"] button[type="submit"]').on('click', function(e) {
    ...
    $.ajax({
      ...
      type: 'POST',
      url: "<?= base_url('technician/job/addJobToProperty') ?>",
      data: {
        post
      },
      dataType: "JSON",
