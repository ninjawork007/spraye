        ...
        <div class="row">
          <div class="<?= $btn_class ?>">
            <div class="tecnician-btn tab-btn">
              <a class="<?= $class1 ?> label btn-technician green-btn" href="#" style="<?= ($is_first_job) ? '' : 'display:none;' ?>">START DAY</a>
            </div>
          </div>
          <div class="<?= $btn_class ?>">
            <div class="tecnician-btn tab-btn">
              <a class="finishday label btn-technician btn-primary" href="#" style="background: #ef6c00;">FINISH DAY</a>
            </div>
          </div>
          <div class="<?= $btn_class ?>">
            <div class="tecnician-btn tab-btn">
                <a data-toggle="modal" class="vehicle_issue fas fa-plus label btn-technician btn-primary" style="background-color:#FFBE2C;" href="#modal_vehicle_issue" id="start_vehicle_issue">VEHICLE ISSUE </a>
            </div>
          </div>
        </div>
      </div>
            ...
            <form action="" name="vehicle_inspection_report" id="vehicle_inspection_report" method="">
                <div class="modal-body">
                            ...
                            <label>Truck</label>
                              <select class="form-control" name="truck_number" id="truck_number" required>
                                ...
                                <?php foreach($vehicles as $value) : ?>
                                  <option value="<?= $value->fleet_id; ?>"<?= ($assigned_vehicle == $value->fleet_id) ? ' selected': ''; ?>><?= $value->fleet_id; ?>: <?= $value->v_name; ?></option>
                                <?php endforeach; ?>
                              </select>
                            </div>
                            <div class="col-sm-6 form-group">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" id="chk_tire_left_front" name="chk_tire_left_front"> Left Front <br><input type="number" id="tire_left_front_psi" name="tire_left_front_psi" class="form-control-custom"> psi
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" id="chk_tire_right_front" name="chk_tire_right_front"> Right Front <br><input type="number" id="tire_right_front_psi" name="tire_right_front_psi" class="form-control-custom"> psi
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" id="chk_tire_left_rear" name="chk_tire_left_rear"> Left Rear <br><input type="number" id="tire_left_rear_psi" name="tire_left_rear_psi" class="form-control-custom"> psi
                                            </label>
                                        </div>
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" id="chk_tire_right_rear" name="chk_tire_right_rear"> Right Rear <br><input type="number" id="tire_right_rear_psi" name="tire_right_rear_psi" class="form-control-custom"> psi
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-sm-12">
                                        <div class="input-group">
                                            <input type="date" id="spreaders_calibration_date" name="spreaders_calibration_date" class="form-control-custom"> Spreader(s)
                                        </div>
                                        <div class="input-group">
                                            <input type="date" id="pump_calibration_date" name="pump_calibration_date" class="form-control-custom"> Pump
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-primary" id="vehicle_inspoection_submit">Submit</button>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-primary">
              ...
              <!-- Form Start -->
              <div class="modal-body">
                <form class="form-horizontal" method="post" name="vehicle_issue_note" enctype="multipart/form-data" id="vehicle_issue_note">
