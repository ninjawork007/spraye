...
<head>
	...
	<script type="text/javascript" src="<?= base_url('assets/customers') ?>/assets/js/plugins/ui/fullcalendar/fullcalendar.min.js"></script><script type="text/javascript" src="<?= base_url('assets/customers') ?>/assets/js/plugins/forms/selects/bootstrap_multiselect.js"></script>
