...
<div class="navbar navbar-inverse <?= $page_name; ?>">
    <div class="navbar-header">
        <a class="navbar-brand" href="#"><img src="<?php echo base_url('assets/admin/image/rsz_logo_color.png') ?>"
                                              alt=""></a>
    ...
    <div class="navbar-collapse collapse" id="navbar-mobile">
        <ul class="nav navbar-nav icon-dash" style="float: inline-start">
            <li><a class="sidebar-control sidebar-main-toggle hidden-xs" id="opentab"><i
            ...
            <?php if ($page_name == 'Completed Service Log' || $page_name == 'Sales Tax Report') { ?>
                ...
                <li class="dropdown language-switch">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="ukrainian" href="<?= base_url('admin/reports/salesTaxReport') ?>"> Sales Tax
                                Report</a></li>
                        <li><a class="ukrainian" href="<?= base_url('admin/reports/salesPipelineSummary') ?>"> Sales
                                Pipeline Summary Report</a></li>
                        <li><a class="ukrainian" href="<?= base_url('admin/reports/salesSummary') ?>"> Sales Summary
                                Report</a></li>
                        <li><a class="ukrainian" href="<?= base_url('admin/reports/salesPipelineDetail') ?>"> Sales
                                Pipeline Detail Report</a></li>
                        <li><a class="ukrainian" href="<?= base_url('admin/reports/salesCommissionReport') ?>">
