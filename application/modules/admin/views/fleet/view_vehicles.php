<style type="text/css">
    ...
    #go_to_open_maintenance_notes:hover {
        box-shadow: 2px 2px 2px 2px #cccccc8a;
        cursor: pointer;
    }
...
<div class="content invoicessss">
    ...
    <div class="panel-body">
        ...
        <div class="row cx-dt">
            ...
            <div class="col-md-3 col-sm-3 col-12">
                <div class="service-bols" id="go_to_open_maintenance_notes">
                    <h3 class="ser-head">Open Maintenance Tickets</h3>
                    <p class="text-danger ser-num"><?= $mnt_count ?></p>
                </div>
            </div>
            <div class="col-md-3 col-sm-3 col-12">
        ...
        <div class="row">
            ...
            <div class="col-md-6 text-right">
                <button type="button" class="btn" id="addVehicleBtn" data-target="#vehicle-form-wrap"
                        data-toggle="collapse" aria-expanded="false" aria-controls="vehicle-form-wrap"><i
                        id="addVehicleBtnIco" class="icon-plus22"></i> Add New Vehicle
                </button>
            </div>
        </div>

        <div id="vehicle-form-wrap" class="collapse">
            <form class="form-horizontal" action="<?= base_url('admin/addVehicle') ?>" method="post" name="addVehicle"
                    ...
                    <div class="row invoice-form">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="v_vin" class="form-control text-caps" value="" id="v_vin"
                                           maxlength="17" placeholder="1FUPDXYB3PP469921" required>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="v_plate" class="form-control text-caps" id="v_plate"
                                           maxlength="7" placeholder="AJFL70" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row invoice-form">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="v_model" class="form-control" value="" id="v_model"
                                           placeholder="F-150" required>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row invoice-form">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="v_name" class="form-control" value="" id="v_name"
                                           placeholder="Work Truck 1">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    <input type="text" name="fleet_number" class="form-control" value=""
                                           id="fleet_number" placeholder="Fleet Number">
                                </div>
                            </div>
                        </div>
                        ...
                        foreach ($vehicles as $vehicle) { ?>
                            <tr>
                                ...
                                <td><a class="btn btn-info" role="button"
                                       href="<?= base_url('admin/viewSingleVehicle/' . $vehicle->fleet_id) ?>">Select
                                        Vehicle</a></td>
                            </tr>
                        <?php }
                    } ?>
...
<script>
    ...
    $(document).ready(function() {
        $('#go_to_open_maintenance_notes').click(function() {
            let url = new URL('<?= base_url('admin/notesViewAll') ?>');
            url.href += '?note_type=3';
