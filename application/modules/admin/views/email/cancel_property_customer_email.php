                  ...
                  <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>
                        ...
                        <h1>Property Cancelled</h1>
                        <p>Hi <?= $customer_details->first_name.' '.$customer_details->last_name ?>,</p>
						<p>The following Property has been cancelled:</p>
						<p><strong>Property: </strong><?= $property_title?></p>
						<p><strong>Address: </strong><?= $property_address?></p>
						<p><strong>Cancel Reason: </strong><?= $cancel_reason ?></p>    
						 <?php if(is_array($services) && count($services) > 0){?>
						  	<br><br><p><strong>Services Cancelled:</strong></p>
						  <?php foreach($services as $service){?>
						  	<p><strong>Program: </strong><?= $service['program_name'] ?></p>
                      ...
                      <?php if(isset($customer_details) && $customer_details->billing_type != 1 && isset($setting_details->slug)) { ?>
                        <td align="right">
                              <a href="<?=base_url("/welcome/").$company_details->slug; ?>" target="_blank">Access Your Account</a>                                     
                        </td>
                      <?php } ?>
                    </tr>
