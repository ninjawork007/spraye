        ...
        <div class="content">
          ...
          <div class="panel-heading">
            ...
            <div class="panel-body">
              ...
              <form class="form-horizontal" action="<?= base_url('admin/servicearea/addServicrAreaData') ?>" method="post" name="addservicearea" enctype="multipart/form-data">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="form-group">
                        ...
                        <div class="col-lg-10">
                          <input type="text" class="form-control" name="category_area_name" id="autocomplete" onFocus="geolocate()"  placeholder="Service Area">
                        </div>
                      </div>
                    </div>
                  </div>
