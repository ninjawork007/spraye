        ...
        <div class="page-content">
            ...
            <div class="content-wrapper">
                ...
                <div class="content pb-20">                             
                    ...
                    <form action="<?= base_url('admin/auth/forgetPassword') ?>" method="POST" name="adminlogin" class="form-validate">
                  <!--    <div class="panel panel-body login-form" style="background-color: transparent;border: 0;border-radius: 0;">
                        ...
                        <div class="panel panel-body login-form login_new" style="background: #01669a;color: #fff;">Admin Forgot Password</div>
