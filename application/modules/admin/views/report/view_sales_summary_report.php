                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="date" id="comparision_range_date_to_new" name="comparision_range_date_to" class="form-control pickaalldate" placeholder="YYYY-MM-DD">
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="date" id="comparision_range_date_from_new" name="comparision_range_date_from" class="form-control pickaalldate" placeholder="YYYY-MM-DD">
                    </div>
                  </div>
                </div>
              </div>
