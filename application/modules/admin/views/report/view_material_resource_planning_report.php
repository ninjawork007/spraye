    ...
    <div class="panel panel-flat">
        <div class="panel-body">
            ...
            <div class="panel panel-body" style="background-color:#ededed;" >
                <form id="searchform" action="<?= base_url('admin/reports/downloadMaterialResourceCsv') ?>" method="post">            
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row"> 
...
function searchFilter() {
   ...
   $('#postList').html('');
    $.ajax({
        type: 'POST',
        url: '<?php echo base_url(); ?>admin/reports/ajaxMaterialResourcePlanningData/', ///// CHECK URL
