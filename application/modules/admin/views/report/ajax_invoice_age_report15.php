        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td>$<?= number_format($report_detail['15_total'],2) ?></td>
                    <td>$<?= number_format($report_detail['30_total'],2) ?></td>
                    <td>$<?= number_format($report_detail['45_total'],2) ?></td>
                    <td>$<?= number_format($report_detail['60_total'],2) ?></td>
                    <td>$<?= number_format($report_detail['75_total'],2) ?></td>
                ...
                <?php 
                    ...
                    $total_15 += $report_detail['15_total'];
                    $total_30 += $report_detail['30_total'];
                    $total_45 += $report_detail['45_total'];
                    $total_60 += $report_detail['60_total'];
                    $total_75 += $report_detail['75_total'];
                ...
                <tr>
                    ...
                    <td><b>$<?= number_format($total_15,2) ?></b></td>
                    <td><b>$<?= number_format($total_30,2) ?></b></td>
                    <td><b>$<?= number_format($total_45,2) ?></b></td>
                    <td><b>$<?= number_format($total_60,2) ?></b></td>
                    <td><b>$<?= number_format($total_75,2) ?></b></td>
                ...
                <tr>
                    ...
                    <td><?php if(isset($aged15_invoices)){ ?><a href="<?=base_url("admin/Invoices/printInvoice/").$aged15_invoices ?>" target="_blank" class="button-next">View Invoices</a><?php }?></td>
                    ...
                    <td><?php if(isset($aged45_invoices)){ ?><a href="<?=base_url("admin/Invoices/printInvoice/").$aged45_invoices ?>" target="_blank" class="button-next">View Invoices</a><?php }?></td>
                    ...
                    <td><?php if(isset($aged75_invoices)){ ?><a href="<?=base_url("admin/Invoices/printInvoice/").$aged75_invoices ?>" target="_blank" class="button-next">View Invoices</a><?php }?></td>
