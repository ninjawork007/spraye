            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="panel panel-flat">
                  <div style="background: #fafafa;padding-top: 10px;padding-bottom: 20px;color: #333;padding-left: 12px;">
                     <span class="scheduled-routes-element text-semibold" style="font-size:15px;">Scheduled Routes</span>  
                    ...
                    <div class="unassigned-services-element" style="float: right;margin-right: 18px;">
                              ...
                              <button type="submit"  disabled="disabled" data-toggle="modal" data-target="#modal_theme_primary" class="btn btn-success" id="allPrintRoute">
...
<script>
   ...
   $('#unassigntbl tfoot td').each( function () {
       ...
       if (title=='TECHNICIAN JOB ASSIGN ID' || title=='TECH NAME' || title=='ROUTE NAME' || title=='ADDRESS' || title=='PROPERTY TYPE' ) {
         ...
         $(this).html( '<select class="form-control dtatableInput" placeholder="'+title+'" ><option value="0" class="default-option">-- Select</option><option value="1">Phone</option><option value="4">Text</option></select>' );
       } else {
