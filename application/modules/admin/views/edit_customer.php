...
border-color : #fd7e14;
    ...
    .div-prop-det{ width: 50%;}
    .div-assi-prog{order: 0 ; width: 50%}
    .div-prop-det2{ width: 50%;/*flex:1 0 130px;*/}
    .div-outs-inv{order: 2; width: 50%;/*flex:1 0 415px;*/}
    .div-uns-ser{order: 1; width: 50%;/*flex:1 0 335px;*/}
    .div-sch-ser{order: 3; width: 50%;/*flex:1 0 335px;*/}
    .div-notes{order: 4; width: 50%;/*flex:1 0 335px*/;}
    ...
    .cus-status-3 { color: #01669A!important;}
    .cus-status-4 { color: #01669A!important;}
    .cus-status-5 { color: #01669A!important;}
    .cus-status-7 { color: #01669A!important;}
    .required{
        color: #c90000;
    }
    .bit-bolder{
...
<div class="content">
    <div class="">
        ...
        <b><?php if($this->session->flashdata()){ echo $this->session->flashdata('message');}?></b>
    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="btndiv col-md-8 ">
                                ...
                                <button type="button" class="btn btn-warning-mod"
                                    ...
                                    data-target="#modal_statement_email" data-toggle="modal"> <i
                                        ...
                                        class=" icon-file-pdf"> </i> Generate Statement</button>
                                ...
                                <button type="button" class="btn btn-primary" id="updatePayment"
                                    ...
                                    disabled <?php } ?>> <i class=" icon-plus22"></i> Update Payment Method</button>

                                <button type="button" class="btn btn-primary" id="add_alert_btn" data-target="#modal_add_alert" data-toggle="modal">
                                    <i class=" icon-plus22"> </i> Add Alert
                                </button>
                                <button type="button" class="btn btn-success" id="add_credit_btn" data-target="#modal_add_credit" data-toggle="modal">
                            ...
                            <div class="form-group col-md-4 col-xs-12 go-to-customer"
                                ...
                                <input autocomplete="off" type="text" class="form-control" id="go_to_customer_field" placeholder="Select any customer" />
                            <div style="z-index: 999; width: 100%; display: none; position: absolute; left: 0px; top: 40px; background-color: #ffffff; overflow-y: scroll; height: 25em; max-height: 25em;" id="suggestion-box2"></div>
                                    
                            <input type="text"  style="display: none !important;"  id="go_to_customer" name="go_to_customer" />
                                ...
                                <div class="col-md-2 col-xs-2">
                                    ...
                                    <button class="btn btn-primary" onclick="goToCustomer()"
                                        id="go_to_customer_btn">Go</button>
        ...
        <div class="panel-body">
            ...
            <div id="customerName" >
                ...
                <h2 style="font-weight: 500"><?php echo $customerData['first_name']." ".$customerData['last_name'] ?>
                    <!--                    <span  style="font-weight: 500; font-size: 15px; margin-left: 2%; color: black">Status <label class="status-label cus-status---><?//=$customerData['customer_status']?><!--" >--><?//= ($customerData['customer_status'] == 1)?'Active':(($customerData['customer_status'] == 2)?'Hold':'Non-Active')?><!--</label>-->
                    <!--                    <span  style="font-weight: 500; font-size: 15px; margin-left: 2%; color: black">Status <label class="status-label cus-status---><?//=$customerData['customer_status']?><!--" >--><?//= ($customerData['customer_status'] == 1)?'Active':(($customerData['customer_status'] == 2)?'Prospect':'Non-Active')?><!--</label>-->
                    <span  style="font-weight: 500; font-size: 15px; margin-left: 2%; color: black">Status <label class="status-label cus-status-<?=$customerData['customer_status']?>" >
                    ...
                    <div class="div-account-number" >
                        <div class="account-number-label" ><span style="font-weight: 500; color: black;margin-right: 5px">Account #</span> <?= @$customer_properties[0]->customer_id?></div>
                    </div>
                </h2>
            ...
            <?php if(isset($alerts) && Count($alerts) > 0) {?>
                ...
                <?php foreach($alerts as $index => $alert) { ?>
                     <span class="alerts-span"><?php echo $alert->text;  if ($alert->show_tech == 1) echo ' <span class="badge badge-info" style="margin-left: 10px;">Tech Visible </span>'; echo '</span><a style="color: #9c1f1f;text-align: end" class="btn" href="'.base_url('admin/removeCustomerAlert/').$index.'-'.$customerData['customer_id'].'"> ';   echo '<i class="icon-trash-alt"> </i></a>' ?>
                <?php } ?>
                    </div>
            <?php } ?>
            ...
            <div class="tabbable">
                ...
                <ul class="nav nav-tabs nav-tabs-solid nav-justified">
                    ...
                    <li class="lione <?php echo $active_nav_link == '1' ? 'active' : ''  ?> "><a
                            ...
                            href="#highlighted-justified-tab1" data-toggle="tab">Profile</a></li>
                    ...
                    <li class="lifive <?php echo $active_nav_link == '5' ? 'active' : ''  ?>"><a href="#highlighted-justified-tab5" data-toggle="tab" id="note_tab_btn">Notes</a></li>
                    ...
                    <div class="tab-pane <?php echo $active_nav_link=='0' ? 'active' : ''  ?>" id="highlighted-justified-tab0">
                        ...
                        <div class="row properties-found-div ">
                            ...
                            <div class="col-md-6 col-xs-8 center" style="min-width:200px; ">
                                ...
                                <select class="bootstrap-select form-control customer-select" data-live-search="true" onchange="selectedProperty()"
        ...
        <!--                            <option value="">Select a Property</option>-->
                        ...
                        <div class="row">
                                        ...
                                        <div class="table-responsive table-spraye table-responsive2 table-spraye2 dash-tbl">
                                            ...
                                            <table class="table table2  dataTable" id="propertyDetails" role="grid">
                                                ...
                                                <tr role="row">
                                                    ...
                                                    <td colspan="3" class="color-grey"><?= (isset($customer_property->property_address))?$customer_property->property_address: ''; ?></td>
                                                </tr>
                                                <tr role="row">
                                                    <td colspan="3" class="col-12 left-column-property-details">Property Type</td>
                                                    <td colspan="3" class="col-12 color-grey"><?=(isset($customer_property->property_type))?$customer_property->property_type: '' ?></td>
                                                </tr>
                                                <tr role="row">
                                                    <td colspan="3" class="left-column-property-details">Email</td>
                                                    <td colspan="3" class="color-grey"><?=(isset( $customerData['email'] ))? $customerData['email']: print_r() ?></td>
                                                </tr>
                                                <tr role="row">
                                                    <td colspan="3" class="left-column-property-details">Phone</td>
                                                    <td colspan="3" class="color-grey"><?=($customerData['phone'] > 0 ? 'M: '.formatPhoneNum($customerData['phone']):'').($customerData['home_phone'] > 0 ? '  H: '.formatPhoneNum($customerData['home_phone']):'').($customerData['work_phone'] > 0 ? '  W: '.formatPhoneNum($customerData['work_phone']):'') ?></td>
                                                </tr>
                                                <tr role="row">
                                                    <td colspan="3" class="left-column-property-details">Property Info</td>
                                                    <td colspan="3" class="color-grey"><?=(isset($customer_property->property_notes))?$customer_property->property_notes: ''?></td>
                                                </tr>
                                                <tr role="row" >
                                                    <td colspan="3" class="left-column-property-details">Source</td>
                                                    <td colspan="3" class="color-grey"><?= (isset($customer_property->source))?$customer_property->source: '' ?></td>
                                                </tr>
                                                <tr role="row">
                                                    <td colspan="3" class="left-column-property-details">Customer Billing Type</td>
                                                    <td colspan="3" class="color-grey"><?=(isset( $customerData['billing_type'] ))?( $customerData['billing_type'] == 0 )? 'Standard': 'Group Billing': ''; ?></td>
                                                </tr>
                                                </tbody>
                                            </table>
                                        </div>
                            ...
                            <div class="col-md-6 col-sm-12" >
                                <div class="row">
                                    <div class="col-md-12 col-sm-12 col-12">
                                        <div class="table-responsive table-spraye table-responsive2 table-spraye2 " style="min-height: 100px!important;">
                            ...
                            <div class="div-assi-prog" >
                                ...
                                <div class="table-responsive table-spraye table-responsive2 table-spraye2 dash-tbl" >
                                    <table class="table table2 dataTable" id="assignedPrograms" role="grid" >
                                        ...
                                        <tr>
                                            <th style="width: 50%"><span class="text-semibold" >Assigned Programs</span></th>
                                            <th class="text-right"style="vertical-align: middle;width: 50%"><?php echo '<a href="#highlighted-justified-tab2" data-toggle="tab" onclick="openTab(\'litwo\')"><i class="see-more-icon icon-list"></i><span class="see-more-text">See more</span></a>'?></th>
                            ...
                            <div class="div-uns-ser" >
                                <div class="table-responsive table-spraye table-responsive2 table-spraye2 dash-tbl" >
                                    <table class="table table2 dataTable" id="unassignedServices" role="grid" >
                                        <thead class="customer">
                                        <tr>
                                            <th style="width: 50%"> <span class="text-semibold" style="">Unscheduled Services</span></th>
                                            <th style="width: 50%" class="text-right" style="vertical-align: middle;"><?php echo '<a href="#highlighted-justified-tab4" data-toggle="tab" onclick="openTab(\'lifour\')"><i class="see-more-icon icon-list"></i><span class="see-more-text">See more</span></a>'?></th>
                                        </tr>
                                        <tr role="row">
                                            <th>Property Name</th>
                                            <th>Service Name</th>
                            ...
                            <div class="div-outs-inv" >
                                <div class="table-responsive table-spraye table-responsive2 table-spraye2 dash-tbl" >
                                    ...
                                    <table class="table table2 dataTable" id="outstandingInvoices" role="grid" >
                                        ...
                                        <thead class="customer">
                                        <tr>
                                            <th  colspan="2" ><span class="text-semibold" style="">Outstanding Invoices</span></th>

                                            <th class="text-right" style="vertical-align: middle;" ><?php echo '<a href="#highlighted-justified-tab3" data-toggle="tab" onclick="openTab(\'lithree\')"><i class="see-more-icon icon-list"></i><span class="see-more-text">See more</span></a>'?></th>
                                        </tr>
                            ...
                            <div class="div-sch-ser" >
                                ...
                                <div class="table-responsive table-spraye table-responsive2 table-spraye2 dash-tbl" >
                                    ...
                                    <table class="table table2 dataTable" id="scheduledServices" role="grid">
                                        ...
                                        <thead class="customer">
                                        <tr>
                                            <th colspan="2"> <span class="text-semibold" style="">Scheduled Services</span></th>
                                            <th class="text-right" style="vertical-align: middle;"><?php echo '<a href="#highlighted-justified-tab2" data-toggle="tab" onclick="openTab(\'litwo\')"><i class="see-more-icon icon-list"></i><span class="see-more-text">See more</span></a>'?></th>
                                        </tr>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-12">
                                        ...
                                        <div class="table-responsive table-spraye table-responsive2 table-spraye2 dash-tbl" >
                                            ...
                                            <tr>
                                                ...
                                                <th colspan="2" class="text-right" style="vertical-align: middle;"><?php echo '<a href="#highlighted-justified-tab5" data-toggle="tab" onclick="openTab(\'lifive\')"><i class="see-more-icon icon-list"></i><span class="see-more-text">See more</span></a>'?></th>
                                            </tr>
                                            ...
                                            <?php	if(isset($combined_notes)){
                                                ...
                                                foreach($combined_notes as $k=>$note){?>
                                                    ...
                                                    <tr role="row">
                                                        ...
                                                        <td><a  class="color-light" href="javascript:goToViewNote('<?= $note->note_id; ?>')"><?= $note->note_contents; ?></a></td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-8">
                                        <div id="note-form-wrap2" class="collapse">
                                            ...
                                            <form class="form-horizontal" style="margin-top: 2%;" action="<?= base_url('admin/createNote') ?>" method="post" name="createnoteform" enctype="multipart/form-data" id="createnoteform" onSubmit="formFileSizeValidate(this)">

                                                <fieldset class="content-group">

                                                    <input type="hidden" name="note_customer_id" class="form-control" value="<?= $customerData['customer_id']; ?>">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    ...
                                                                    <select class="form-control" name="note_property_id" placeholder="None">

                                                                        <option value="0">None</option>

                                                                        <?php

                                                                        if (!empty($customer_properties)) { foreach ($customer_properties as $value) {

                                                                            if(in_array($value->property_id, $selectedpropertylist )) { ?>



                                                                                <option value="<?= $value->property_id; ?>" <?= ($uriSegments[5] ==$value->property_id)?'selected':'' ?>><?= $value->property_title; ?></option>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-10">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <label class="control-label col-lg-5 text-right">Attach Documents</label>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group checkbox">
                                                                <label class="control-label col-lg-3 text-left">Include in Technician View?</label>
                                                                <div class="col-lg-2">
                                                                    <input id="include_in_tech_view" type="checkbox" name="include_in_tech_view" class="checkbox text-left" value="1">
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <div class="form-group checkbox">
                                                                <label class="control-label col-lg-3 text-left">Include in Customer View?</label>
                                                                <div class="col-lg-2">
                                                                    <input id="include_in_customer_view" type="checkbox" name="include_in_customer_view" class="checkbox text-left" value="1">
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="col-sm-3 pull-right text-right text-white" style="margin-top: 15px" >
                                        ...
                                        <button type="button"  class="btn" id="addNoteBtn"   data-target="#modal_new_note" data-toggle="modal" style="margin-left=15px;"> <i id="addNoteBtnIco" class="icon-plus22"></i> Add New Note</button>
                        ...
                        <form class="form-horizontal" action="<?= base_url('admin/updateCustomer') ?>" method="post"
                            ...
                            <fieldset class="content-group">
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div id="subscribeTooltip" class="checkbox" data-popup="tooltip-custom"
                                                            ...
                                                            <label class="checkbox-inline checkbox-right">
                                                                ...
                                                                <input id="subscribeButton" type="checkbox" name="is_email"
                                                ...
                                                <div class="form-group ">
                                                    ...
                                                    <center>
                                                        ...
                                                        <a <?php echo $hide_reset_link ?> id="reset_secondary_email_link"
                                                            ...
                                                            href="#"><i class="icon-reset text-success pt-6"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <input type="text" id="autocomplete" class="form-control" name="billing_street"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <input type="text" class="form-control" id="locality" name="billing_city"
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <select class="form-control" name="billing_state" id="region">
                                                    ...
                                                    <optgroup label="Canadian Provinces">
                                                        <option value="AB" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >Alberta</option>
                                                        <option value="BC" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >British Columbia</option>
                                                        <option value="MB" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >Manitoba</option>
                                                        <option value="NB" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >New Brunswick</option>
                                                        <option value="NF" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >Newfoundland</option>
                                                        <option value="NT" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >Northwest Territories</option>
                                                        <option value="NS" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >Nova Scotia</option>
                                                        <option value="NU" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >Nunavut</option>
                                                        <option value="ON" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >Ontario</option>
                                                        <option value="PE" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >Prince Edward Island</option>
                                                        <option value="QC" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >Quebec</option>
                                                        <option value="SK" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >Saskatchewan</option>
                                                        <option value="YT" <?php  if($customerData['billing_state']=='AL') { echo "selected"; } ?> >Yukon Territory</option>
                                                    </optgroup>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-9">
                                                ...
                                                <input type="text" class="form-control" id="postal-code" name="billing_zipcode"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                          ...
                                          <div class="col-lg-9">
                                              <input type="hidden" name="billing_type" value="<?=$customerData['billing_type']?>">
                                            <select  class="form-control" name="billing_type_select" disabled>
                                              <option value=0 <?php if ($customerData['billing_type']==0){ echo "selected";}  ?> >Standard</option>
                                              <option value=1 <?php if ($customerData['billing_type']==1){ echo "selected";}  ?> >Group Billing</option>
                                            </select>
                                          </div>
                                        </div>
                                      </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input autocomplete="off" type="text" class="form-control" id="property_list_field" value = "<?php $lengthOfArray = count($id);
                                    ...
                                    <div style = "display: none;" id="property_list_div">
                                        <select style = "display: none;" name="assign_property[]" multiple="multiple" id="property_list" data-existingproperties="<?php echo implode(',',$selectedpropertylist);?>">
                                    ...
                                    <div class="col-lg-1 col-sm-2 col-xs-2 addbuttonmanage">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <center>
                                                ...
                                                <a href="#" data-toggle="modal" data-target="#modal_add_property"><i
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-9">
                                        <select class="form-control" name="customer_status">
                                            ...
                                            <option value="1" <?php if ($customerData['customer_status']==1){ echo "selected";}  ?>>
                                                Active</option>
                                            <option value="0" <?php if ($customerData['customer_status']==0){ echo "selected";}  ?>>
                                                Non-Active</option>
                                            <option value="2" <?php if ($customerData['customer_status']==2){ echo "selected";}  ?> >Hold</option>
                                            <option value="4" <?php if ($customerData['customer_status']==4){ echo "selected";}  ?> >Sales Call Scheduled</option>
                                            <option value="5" <?php if ($customerData['customer_status']==5){ echo "selected";}  ?> >Estimate Sent</option>
                                            <option value="6" <?php if ($customerData['customer_status']==6){ echo "selected";}  ?> >Estimate Declined</option>
                                            <option value="7" <?php if ($customerData['customer_status']==7){ echo "selected";}  ?> >Prospect</option>
                                        </select>
                                          </div>
                                      </div>
                                  </div>
                              ...
                              <div class="multi-select-full col-lg-9  col-sm-10 col-xs-10">
                                <select class="multiselect-select-all-filtering form-control" id="pre_service_notification" name="pre_service_notification[]" multiple="multiple" value="">
                                  <option value="1" <?=in_array(1,$notify_flag)? "selected":"";?> >Phone Call</option>
                                  <option value="2" <?=in_array(2,$notify_flag)? "selected":"";?> >Automated Email(s)</option>
                                  <option value="3" <?=in_array(3,$notify_flag)? "selected":"";?> >Automated Text message(s)</option>
                                  <option value="4" <?=in_array(4,$notify_flag)? "selected":"";?> >Text when En route</option>
                                </select>
                              </div>
                            </div>
                          </div>
                        ...
                        <div class="row" style="padding: 20px 0;">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label col-lg-3 col-sm-12 col-xs-12">Apply Permanent
                                                ...
                                                Coupons<small style="font-size: 13px;"><br>this will apply to all unpaid and
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <label class="control-label col-lg-3">Auto-Charge
                                                ...
                                                <label class="togglebutton" style="font-size:16px">Do you want to run customer
                                                    ...
                                                    credit card automatically upon job completion? <span
                                                        ...
                                                        data-placement="top"> <i class=" icon-info22 tooltip-icon"></i>
                                            ...
                                            <div class="col-lg-4">
                                                ...
                                                <input name="clover_autocharge" type="checkbox" class="switchery-autocharge"
                                                ...
                                                <input name="autocharge" type="checkbox" class="switchery-autocharge"
                            ...
                            <div class="text-right">
                                ...
                                <button type="submit" class="btn btn-success">Save <i
                                        ...
                                        class="icon-arrow-right14 position-right" id="submit-update-customer-form"></i></button>
                                    ...
                                    <form action="" method="post" id="apply_discount_form">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    ?>
                                                            ...
                                                            <option value='REMOVE-ALL'>Remove coupons from selected services
                                            ...
                                            <div class="modal-footer" style="padding: 0;">
                                                ...
                                                <button type="submit" id="savearea" class="btn btn-success">Apply Coupon to
                        ...
                        <div class="table-responsive table-spraye">
                            ...
                            <table class="table datatable-basic" id="customer-services">
                                ...
                                <button type="button" class="btn btn-primary" data-toggle="modal"
                                    data-target="#modal_apply_discount_services" onclick="applyDiscount()">Apply Coupon</button>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th>Service Area</th>
                                        <th>Program</th>
                                        <th> Cost <span data-popup="tooltip-custom" title="Services with no invoice won't reflect price override until invoice is created." data-placement="top" >  <i class=" icon-info22 tooltip-icon"></i> </span>
                                        </th>
                                        <th>Completion Status</th>
                                        <th>Sales Rep</th>
                                        <th>Coupons</th>
                                        <th>Active Status</th>
                                       <?php if(isset($customerData['billing_type']) && $customerData['billing_type']==1){ ?><th>Action</th><?php } ?>
                                    </tr>
                                </thead>
                                     ...
                                     if (!empty($all_services)) {
                                         ...
                                         foreach ($all_services as $value) {
                                            ...
                                            <tr class="<?=$asapClass?>">
                                                ...
                                                <td class="table-action">
                                                    <ul style="list-style-type: none; padding-left: 0px;">
                                                        ...
                                                        <?php if ($value->cancelled==0 && $value->is_job_mode != 1) { ?>
                                                            <li style="display: inline; padding-right: 10px;" >
                                                                <a href="#" class="confirm_cancellation" onclick="cancelService(<?= $value->property_id ?>,<?= $value->customer_id ?>,<?= $value->program_id ?>,<?= $value->job_id ?>)" >
                                                ...
                                                <a href="<?= base_url('admin/invoices/groupBillingPdf/').$value->invoice_id ?>" target="_blank" title="Print Work Order" class=" button-next"><i class=" icon-file-pdf position-center" style="color: #9a9797;"></i></a>
                                                <?php } ?>
                                                </td>
                                                <?php } ?>
                                            </tr>
                    ...
                    <div class="tab-pane <?php echo $active_nav_link == '3' ? 'active' : ''  ?>" id="highlighted-justified-tab3">
                        ...
                        <div class="table-responsive table-spraye ">
                            ...
                            <tr>
                                ...
                                <td><a href="<?= base_url('admin/Invoices/editInvoice/').$value->invoice_id ?>"

                                        target="_blank" rel="noopener noreferrer"><?= $value->invoice_id; ?></a></td>
                    ...
                    <!-- NOTES TAB -->
                    <div class="tab-pane<?php echo $active_nav_link == '5' ? ' active' : ''  ?>" id="highlighted-justified-tab5">

                        <div id="note-form-wrap" class="collapse">

                            <form class="form-horizontal" action="<?= base_url('admin/createNote') ?>" method="post" name="createnoteform" enctype="multipart/form-data" id="createnoteform" onSubmit="formFileSizeValidate(this)">
                                    ...
                                    <div class="row">
                                      ...
                                      <div class="col-md-3">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-lg-9">
                                            ...
                                            <select class="form-control" name="note_type" required id="notetypenotcusedi">
                                      ...
                                      <div class="col-md-3">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <div class="form-group">
                                                    <label class="control-label col-lg-3" style="font-size:16px;">Attach Documents</label>
                                                    <input id="files" type="file" name="files[]" class="form-control-file col-lg-9" multiple onChange="fileValidationCheck(this)" style="display:inline-block; padding-top: 12px;">
                                                    <span style="color:red;"><?php echo form_error('files'); ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group checkbox-inline checkbox-right">
                                                    <label class="control-label" style="font-size:16px;">Include in Technician View?</label>
                                                    <input id="include_in_tech_view" type="checkbox" name="include_in_tech_view" class="checkbox checkbox-inline text-right" value="1">
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <div class="form-group checkbox-inline checkbox-right">
                                                    <label class="control-label" style="font-size:16px;">Include in Customer View?</label>
                                                    <input id="include_in_customer_view" type="checkbox" name="include_in_customer_view" class="checkbox checkbox-inline text-right" value="1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 col-sm-12">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6 form-inline" style="padding-left:15px;">

                            <label for="note_property_filter">Property Filter</label>

                            <select class="form-control" name="note_property_filter" id="note_property_filter" placeholder="None">
                          ...
                          <div class="col-md-3 pull-right text-right text-white">
                            ...
                            <button type="button"  class="btn" id="addNoteBtn" data-target="#note-form-wrap" data-toggle="collapse" aria-expanded="false" aria-controls="note-form-wrap" style="margin-left=15px;"> <i id="addNoteBtnIco" class="icon-plus22"></i> Add New Note</button>
                ...
                <div class="row" id="note_tab_contents">
                  ...
                  <?php if(!empty($combined_notes))
                    ...
                    <div class="well note-element<?= ($note->note_category == 0) ? ' property-note' : ' customer-note' ?>" data-note-id="<?= $note->note_id; ?>" data-note-status="<?= (!empty($note->note_assigned_user)) ? $note->note_status : '0'; ?>">
						  ...
						  <div class="col-lg-4">
						  	<div class="form-group hidden" id="update-notetype-<?= $note->note_id; ?>">
								<label class="control-label">Note Type</label>
								  <select class="form-control" name="note_edit_type" id="note_edit_type_<?= $note->note_id; ?>" data-note-id="<?= $note->note_id; ?>" data-note-typeid="<?= $note->note_type; ?>" onchange="getNoteTypeUpdateVars(this)" value="">
                        ...
                        <div class="col-md-7 note-footer-left">
                          ...
                          <div class="row">
                            ...
                            ?>
                              ...
                              <div class="customer-address col-sm-12 col-md-8 col-lg-6 text-bold" data-propertyid="<?= $note->property_id; ?>">
                          ...
                          <div class="col-md-12">
                            ...
                            <ul class="list-group comments-list-group">
                              ...
                              <li class="list-group-item comment-list-item">
                                ...
                                <form action="<?= base_url('admin/Note/addNoteComment') ?>" method="post" name="add-note-comment-form" enctype="multipart/form-data" id="add-note-comment-form-<?= $note->note_id; ?>" onsubmit="addCommentAjax('<?= $note->note_id; ?>')">
            ...
            <form method="POST"
                  ...
                  class="alert-modal">
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" required type="text" id="alert_text" name="alert_text" maxlength="100" size="100" spellcheck="true">
                    </div>
                <div class="form-group">
    ...
    <div class="modal-dialog">
        <div class="modal-content generate_statment_modal_content" style="height: 305px;">
            ...
            <form id="statement_form" method="POST"
                action="<?= base_url('admin/invoices/getOpenInvoiceByCustomer/').$customerData['customer_id'] ?>" style="margin-top: 20px; padding: 0 20px;">
                ...
                <div class="col">
                    <div class="form-group">
                        ...
                        <button id='print_statment_button' class="btn btn-warning" type="button"><i class=" icon-file-pdf"></i> Print
                            Statement</button>
                        <!-- <a style="margin-top: 26px; margin-left: 25px;" class="btn btn-success"  ><i class=" icon-file-pdf"> </i> Generate Statement</a> -->
                        <button id='email_statment_button' class="btn btn-success" type="button"><i class=" icon-file-pdf"></i> Send
                            To Email</button>
                        <button id='send_statment_button' class="btn btn-success" type="submit" style="display: none;"><i class=" icon-file-pdf"></i> Send
                            </button>
                    </div>
                </div>
...
<div id="modal_new_note" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content" >
            ...
            <form class="form-horizontal" style="height: 500px;overflow-y:scroll; padding: 5%" action="<?= base_url('admin/createNote') ?>" method="post" name="createnoteform" enctype="multipart/form-data" id="createnoteform" onSubmit="formFileSizeValidate(this)">
                ...
                <fieldset class="content-group">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-lg-5">Assign Property</label>

                                <div class="col-lg-7">

                                    <select class="form-control" name="note_property_id" id="note_property_id" placeholder="None">
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-lg-5">Note Type</label>
                        ...
                        <div class="col-md-10">
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-lg-5">Assign User</label>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-lg-6 text-right">Attach Documents</label>
                    ...
                    <div class="row">
                        <div class="col-md-12 ">
                            <div class="form-group checkbox">
                                <label class="control-label col-lg-5 text-left">Include in Technician View?</label>
                                <div class="col-lg-2">
                                    <input id="include_in_tech_view" type="checkbox" name="include_in_tech_view" class="checkbox text-left" value="1">
                                </div>
                            </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group checkbox">
                                <label class="control-label col-lg-5 text-left">Include in Customer View?</label>
                                <div class="col-lg-2">
                                    <input id="include_in_customer_view" type="checkbox" name="include_in_customer_view" class="checkbox text-left" value="1">
                                </div>
                            </div>
                    ...
                    <div class="row" style="margin-top: 3%">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <label class="control-label col-lg-2">Note Contents</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
    	<div class="modal-header bg-primary" style="background: #36c9c9;border-color: #36c9c9;">
      	...
      	<div class="modal-body">
			    <form action="<?= base_url('admin/cancelService') ?>" method="POST" enctype="multipart/form-data" id="cancel-service-form">
...
$(function() {
  ...
  $('#note-filter-customer').click(function(e) {
    ...
    Array.from($('.note-element')).forEach((note) => {
      ...
      } else if($(note).hasClass('property-note')) {
  ...
  $('#note-filter-property').click(function(e) {
    ...
    Array.from($('.note-element')).forEach((note) => {
      ...
      } else if($(note).hasClass('customer-note')) {
...
$(document).on("click","input[name='is_email']",function(){
    if($(this).prop("checked") == false) {
        $("#pre_service_notification option[value=2]").attr('selected', false); reinitMultiselect();
    }
})
...
$(document).on("click","input[name='is_mobile_text']",function(){
    if($(this).prop("checked") == false) {
        $("#pre_service_notification option[value=3]").attr('selected', false); reinitMultiselect();
    }
})
 ...
 function getNoteTypeUpdateServiceSpecificVars(el){
  ...
  $(document).ready(function(){
    ...
    $('#note_property_filter').on('change', function(e) {
      ...
      filterNotesByProperty(e.target.value);

    });

    $('#note_status_filter').on('change', function(e) {

      filteringNoteStatusEvent();

    });       

  });

  function filterNotesByProperty(propertyId) {

    Array.from($('.properties-tab-btn')).forEach((btn) => $(btn).removeClass('properties-tab-active'));

    $('#note-filter-all').addClass('properties-tab-active');
    ...
    Array.from($('.note-element')).forEach((note) => {
      ...
      if(propertyId != '0') {
        ...
        if($(note).has(`[data-propertyid="${propertyId}"]`).length == 0) {
  ...
  function filteringNoteStatusEvent() {

    $('.properties-tab-active').get(0).click();
