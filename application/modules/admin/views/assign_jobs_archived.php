                   ...
                   <h5 class="panel-title">
                        <div class="form-group">
                          <a href="<?= base_url('admin')?>" id="save" class="btn btn-success"><i class=" icon-arrow-left7"> </i> Back to Dashboard</a>
                             ...
                             <button id="multiple-restore-id" disabled="disabled" class="btn btn-primary archived-services-element">Restore Services</button>
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
               <div class="panel panel-flat">
                  <div style="background: #fafafa;padding-top: 10px;padding-bottom: 20px;color: #333;padding-left: 12px;">
                     <span class="unassigned-services-element text-semibold hidden" style="font-size:15px;">Unassigned Services</span>  
                     <span class="archived-services-element text-semibold" style="font-size:15px;">Archived Services</span>  
                     <!-- <span class="unassigned-services-element">Highlighted jobs indicate this job has been skipped and needs to be rescheduled</span>             -->
					  ...
					  <!-- <div class="unassigned-services-element" style="float: right;margin-right: 18px;">
						  <input placeholder="Total Sq Feet" id="totalSqFt" type="text">
    ...
    else
    {
     ...
     $('.myCheckBox').each(function(){ //iterate all listed checkbox items
		 ...
		 if ($(this).is(':checked')) {
		 	...
		 	sqftTotal = sqftTotal + parseInt($(this).parent().parent().find('.sqft').html());
		 }
     });
   ...
   $('.myCheckBox').change(function(){
	    ...
	    ///////////////////////////////
			...
			$('#unassigntbl tbody input:checked').each(function() {
				//console.log('1'); 
				console.log($(this).parent().parent().find('.sqft').html());
...
<script>
   ...
   var table =  $('#unassigntbl').DataTable({
       ...
       "processing": true,
		   ...
		   "order":[[1,"asc"]],
		   "ajax":{
		     "url": "<?= base_url('admin/ajaxGetRoutingArchived/')?>",
		     "dataType": "json",
		     "type": "POST",
		     "data":{
   ...
   // table.$(':contains("data-row-job-mode")').addClass('rescheduled_row');
   // table.on( 'xhr', function () {
   //    console.log('UPDATREEEEEEEEEE');
   // } );
