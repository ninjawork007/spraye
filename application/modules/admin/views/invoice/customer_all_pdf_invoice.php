...
<table width="100%" style="margin-bottom: 20px;">
  ...
  <tr id="top-fold">
    <td valign="top">
      <address>
        ...
        <?php echo $setting_address_first.'<br>'.$setting_address_last; ?>
        <br>
        <?php 
 ...
 <table width="100%" class="table table-condensed">
  <tr class="first_tr">
    <td><strong>STATEMENT NO: #<?= $customer_details['customer_id'].$setting_details->company_id ?></strong>&#160;&#160;&#160;&#160;&#160;&#160;&#160;<strong>CUSTOMER ID: <?= $customer_details['customer_id'] ?></strong>
    </td>
    <td align="right"> 
      <strong>
        <?php
      ...
      <table width="100%" >
        ...
        <td align="left" width="40%">
          <table width="100%" >
            ...
            <?php endif; ?>
            <?php
            if (!isset($total_late_fee)) $total_late_fee = 0;
            if( $total_late_fee> 0): ?>
              <tr>
                <td>Late Fee </td> 
                <td>$</td>    
            ...
            <td class="text-left"><?= $value->property_address . " " . $value->property_city . ", " . $value-> property_state . " " . $value->property_zip; ?> - Refund paid:
              <span>
                ...
                switch ($refund->refund_method) {
                  ...
                  break;
                  case "2":
                  echo 'BAYSYS: '.$refund->cc_number;
                  break;
                  case "3":
                  echo 'Other: '.$refund->refund_note;
                  break;
                  case "4":
                  echo 'Clover: '.$refund->cc_number;
                  break;
                  default:
...
<table width="100%" class="main_table" >
    <tr>
     <td class="text-center" style="font-size: 14px"><b>Thank you for your business!</b></td>
   </tr>
 </table>
