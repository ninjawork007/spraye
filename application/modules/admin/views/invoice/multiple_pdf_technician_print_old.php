...
<body>
 ...
 <!-- Tech Header --> 
 <div style="padding: 5rem 0" class="container <?php echo $page_break_class ?>"  >

  <table width="100%" class="table table-bordered border-primary" >
    
    <tr>
      <td colspan="2" style="font-size: 24px; text-transform: uppercase;" ><strong><?= $setting_details->company_name ?></strong></td>
      <td colspan="2"  text-align="left"><span class='default-font-color'>Route Name: </span> <?= $assigned_job_details->route_name?> </td>
      <td colspan="2"  text-align="left"><span class='default-font-color' >Date: </span><?=  date("m/d/Y" ,strtotime( $assigned_job_details->job_assign_date)) ?></td>
    </tr>
    <tr>
      <td colspan="6" ><span class='default-font-color' >Route Notes: </span> <?= $assigned_job_details->job_assign_notes ?> </td>
    </tr>
...
<tr style="border-top: 2px solid" >
  <td colspan="2">
    <strong><?= $assigned_job_details->first_name.' '.$assigned_job_details->last_name ?></strong>
  </td>
  <td colspan="2" text-align="left">
    <strong>Time: 3:00 PM</strong>
  </td>
...
<tr >
  ...
  <td colspan="2"  valign="top" text-align="left">
    <strong><span>Mobile: </span></strong> <?=  preg_replace("/^1?(\d{3})(\d{3})(\d{4})$/", "($1) $2-$3", $value->phone) ?> <br>
   <strong><span>Home: </span>
   <?=$invoice_detail->home_phone = 0 ? $invoice_detail->home_phone : '' ?>  
  </strong> <br>
   <strong><span>Work: </span>
   <?=$invoice_detail->work_phone = 0 ? $invoice_detail->work_phone : '' ?>  
  </strong> 
  </td>
  <td colspan="2" valign="top">
        <?php 
...
<tr style="border-top: 2px solid; border-bottom: 2px solid;" >
  <td colspan="6" style="font-size: 20px; color: red; text-transform: uppercase; text-align: center"><?= $assigned_job_details->job_notes ?></td>
  
</tr>

  <tr >
    <td class='default-font-color' ><strong >SERVICE NAME(S)</strong></td>
    <td style="text-align:center" ><?= $assigned_job_details->job_name ?></td>
    <td class='default-font-color' ><strong>SERVICE NOTES</strong></td>
    <td colspan="3" style="text-align:center"><?= $assigned_job_details->job_description ?></td>
    
  </tr>
  <tr>
    <td class='default-font-color' ><strong>PROGRAM NAME</strong></td>
    <td style="text-align:center" ><?= $assigned_job_details->program_name ?></td>
    <td class='default-font-color' ><strong>PROGRAM NOTES</strong></td>
    <td colspan="3" style="text-align:center"><?= $assigned_job_details->program_notes ?></td>
    
  </tr>
  <tr>
    <td class='default-font-color' ><strong>GRASS TYPE (FRONT/BACK)</strong></td>
    <td style="text-align:center">
    <?= $assigned_job_details->front_yard_grass ?> / <?= $assigned_job_details->back_yard_grass ?>
  </td>
    <td class='default-font-color' ><strong>LAWN SIZE (FRONT/BACK)</strong></td>
    <td style="text-align:center" colspan="3">
    <?= $assigned_job_details->front_yard_square_feet ?> <span>sq.ft</span> / <?= $assigned_job_details->back_yard_square_feet ?> <span>sq.ft</span>
  </td>
  </tr>
  <tr class="border-bottom" style="border" >
    <td style="text-align:right" ><strong>START/COMPLETE TIME : </strong></td>
    <td style="text-align:center"> 8:30 <span>AM / PM</span></td>
    <td style="text-align:right"><strong>WIND SPEED : </strong></td>
    <td style="text-align:center"> <?= $assigned_job_details->wind_speed ?> <span>MPH</span></td>
    <td style="text-align:right" ><strong>TEMPERATURE :</strong></td>
    <td style="text-align:center"> <?= $assigned_job_details->wind_speed ?> <span>Degrees</span> </td>
  </tr>

  <tr>
    <td class='default-font-color' ><strong>PRODUCTS USED</strong></td>
    <td text-align="left" colspan="3">
      <?= $assigned_job_details->product_name ?> 
    </td>
    <td text-align="left" colspan="2">(Amount Applied:)______________</td>
    
  </tr>
  <tr>
    <td class='default-font-color' ><strong>PROPERTY INFO</strong></td>
    <td colspan="5" style="font-size: 20px">
    <?= $assigned_job_details->property_notes ?>
    
  </td>
    
  </tr>
  <tr  >
    <td class='default-font-color' style="font-size: 10px" ><strong>ADD NOTE/LAWN <br>
  CONDITION/SKIP REASON</strong></td>
  <td colspan="5"></td>
          ...
          <td colspan="2" class="cl_50">
            ...
            <table class="table table-condensed" >
              <tr>
                ...
                <td class="border-bottom-blank-td text-right">$ <?= number_format($total_inv_line_costs,2); ?></td>
												...
												<td></td>
													<?php
														if ($coupon_details->coupon_amount_calculation == 0) {
															echo '<td class="border-bottom-blank-td text-left default-font-color">'.$coupon_details->coupon_code.'</td><td class="border-bottom-blank-td text-right">';
															...
															echo '<td class="border-bottom-blank-td text-left default-font-color">'.$coupon_details->coupon_code.' (-'.$percentage.'%)</td><td class="border-bottom-blank-td text-right">';
                                 ...
                                 $total_tax_amount +=  $invoice_sales_tax_details['tax_amount'];
								  ...
								  <tr>
										...
										<td class="border-bottom-blank-td text-right">$
										  ...
										  <?php
										  	$tax_amm = $invoice_total_cost * ($invoice_sales_tax_details['tax_value'] / 100);
										  	if ($invoice_sales_tax_details['tax_value'] != 0) {
												$invoice_total_cost += $tax_amm;
											}
										  ?>
										  <?= number_format($tax_amm ,2);  ?></td>
								  </tr>
              <?php } } ?>
              ...
              <tr>
                ...
                <td class="border-bottom-blank-last text-left default-font-color">PAYMENT
                  <?= isset($invoice_detail->payment_created) && $invoice_detail->payment_created !='0000-00-00 00:00:00' && $invoice_detail->payment_status==2 ? date("(m/d/Y)" ,strtotime( $invoice_detail->payment_created)) : ''  ?>
                </td>
       ...
       <?php  if ( $invoice_detail->partial_payment > 0 && $invoice_detail->payment_status != 2) { ?>
              ...
              <tr>
                ...
                <td class="border-bottom-blank-last text-left default-font-color">PARTIAL PAYMENT
                  <?= isset($invoice_detail->payment_created) && $invoice_detail->payment_created!='0000-00-00 00:00:00' ? date("(m/d/Y)" ,strtotime( $invoice_detail->payment_created)) : ''  ?>
                </td>
                <td class="border-bottom-blank-last text-right">- $
                  <?php
		  ...
		  <!-- START APPLICATIONS SECTION -->
				...
				<td width="100%">
					<table width="100%" class="table table-condensed mannual application_tbl" style="margin-bottom: 20px; margin-top:20px;">
							...
							<table width="100%" class="table table-condensed inside-tabel mannual application_tbl" style="font-size:12px;" cellspacing="0">
								  <thead>
									<tr class="first_tr" style="text-transform:uppercase;">
										<td colspan="3" valign="middle">&nbsp;&nbsp;APPLICATION & PRODUCT DETAILS</td>
        				...
        				<?php  if($product_details) { 
      					if ($setting_details->is_product_name || $setting_details->is_epa || $setting_details->is_active_ingredients || $setting_details->is_application_rate || $setting_details->is_estimated_chemical_used || $setting_details->is_chemical_type || $setting_details->is_re_entry_time || $setting_details->is_weed_pest_prevented || $setting_details->is_application_method   ) { ?>
							...
							<table width="100%" class="table table-condensed inside-tabel mannual application_tbl" style="font-size:10px;" cellspacing="0">
								  <thead>
									<tr class="default-font-color">
									  ...
									  <td class="border-bottom-blank-td default-font-color" align="center">APPLICATION METHOD</td>
    			...
    			?>
									   	<tr>
											...
											<td class="border-bottom-blank-td" align="center">
											 <?php if ($setting_details->is_application_method==1 && $product_details_value->application_method!=0 ) {
												$application_method ='';
												if ($product_details_value->application_method==1) {
													$application_method = 'Broadcast';
												} else if($product_details_value->application_method==2) {
													$application_method = 'Spot Spray';
												} elseif ($product_details_value->application_method==3) {
