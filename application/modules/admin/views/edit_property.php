    ...
    <div class="panel panel-flat">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="btndiv">
                                    ...
                                    <a href="<?= base_url('admin/editCustomer/'.$selectedcustomerlist[0].'/'.$propertyData['property_id']) ?>" id="save" class="btn btn-success"><i class="icon-arrow-left7"></i> Back to Customer Quickview</a>
                                    ...
                                    <button type="button" class="btn btn-info" id="addServiceButton"
                                        ...
                                        data-target="#modal_add_service" data-toggle="modal"> <i
                                            ...
                                            class=" icon-plus22"></i> Add Standalone Service</button>
                        ...
                        <?php if((isset($customer_alerts) && Count($customer_alerts) > 0) ||  ((isset($property_alerts) && Count($property_alerts) > 0))){ ?>
                            <div class="alerts">
                                <?php if (isset($customer_alerts) && Count($customer_alerts) > 0) { ?>
                                    <?php foreach($customer_alerts as $index => $alert) { ?>
                                        <span class="alerts-span"><?php echo $alert->text; echo '</span><a style="color: #9c1f1f;" class="btn" href="'.base_url('admin/removeCustomerAlert/').$index.'-'.$customer_id.'"> <i class="icon-trash-alt"> </i></a>' ?>
                                    <?php } ?>
                                <?php } ?>
                                <?php if (isset($property_alerts) && Count($property_alerts) > 0){ ?>
                                    <?php foreach($property_alerts as $index => $alert) { ?>
                                        <span class="alerts-span"><?php echo $alert->text; echo '</span><a style="color: #9c1f1f;" class="btn" href="'.base_url('admin/removePropertyAlert/').$index.'-'.$propertyData['property_id'].'"> <i class="icon-trash-alt"> </i></a>' ?>
                                    <?php } ?>
                                <?php } ?>
                            </div>
                        <?php } ?>
                      <div class="form-group">
                        ...
                        <div class="row">
                          ...
                          <div class="col-md-6">
                            ...
                            <div class="btn-group btn-group-justified" role="group" aria-label="tab-select">
                              ...
                              <div class="btn-group properties-tab-parent" role="group">
                                ...
                                <button type="button" class="btn btn-default properties-tab-btn properties-tab-active" id="properties-tabbtn-1">Properties Profile</button>

                              </div>

                              <div class="btn-group properties-tab-parent" role="group">

                                <button type="button" class="btn btn-default properties-tab-btn" id="properties-tabbtn-2">Notes</button>
                          ...
                          <div class="col-md-6 text-right">
                            ...
                            <button type="button"  class="btn" id="addNoteBtn" data-target="#note-form-wrap" data-toggle="collapse" aria-expanded="false" aria-controls="note-form-wrap" style="display: none;"> <i id="addNoteBtnIco" class="icon-plus22"></i> Add New Note</button>                            
        ...
        <div class="panel-body">
            <b><?php if ($this->session->flashdata()) : echo $this->session->flashdata('message'); endif; ?></b>
              <form class="form-horizontal properties-tab" action="<?= base_url('admin/updateProperty') ?>" method="post" name="addproperty" enctype="multipart/form-data" id="properties-tab-1">
                <fieldset class="content-group">
						...
						<div class="col-md-6">
                            <div class="form-group">
                                ...
                                <?php
                                    ...
                                    <input autocomplete="off" type="text" class="form-control" id="customer_list_field" value = "<?php $lengthOfArray = count($id);
                                    ...
                                    <div style = "display: none;" id="customer_list_div">
                                        <select style="display: none;" name="assign_customer[]" multiple="multiple" id="customer_list">
                    ...
                    <?php if(isset($is_group_billing) && $is_group_billing == 1){ $hide = 1;?>
						<input type="hidden" name="is_group_billing" value=1/>
					<?php }else{ $hide = 0;?>
						<input type="hidden" name="is_group_billing" value=0/>
					<?php } ?>
					<div class="row group_billing_contact_info" <?php if(isset($hide) && $hide!=1){ echo 'style="display:none;"';} ?>>
						<?php if(isset($groupBilling['group_billing_id'])){ ?>
						<input type="hidden" name="group_billing_id" value="<?= $groupBilling['group_billing_id']; ?>"/>
						<?php } ?>
						<div class="col-md-6">
							<div class="form-group">
								<label class="control-label col-lg-3">Property First Name</label>
								<div class="col-lg-9">
									<input type="text" class="form-control" name="property_first_name" value="<?= $groupBilling['first_name'] ?>" placeholder="Property First Name" required>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-lg-9">
									<input type="text" class="form-control" name="property_last_name" value="<?= $groupBilling['last_name'] ?>" placeholder="Property Last Name" required>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-lg-9">
									<div class="row">
										<div class="col-md-9">
											<input type="text" class="form-control" name="property_phone" value="<?= $groupBilling['phone'] ?>" placeholder="Property Phone" required>
										...
										<div class="col-md-3">
											<div class="checkbox">
												<label class="checkbox-right" >
													<input type="checkbox" name="property_is_text" class="switchery-is-text" <?php echo $groupBilling['phone_opt_in']==1 ? 'checked' : '' ?>/>&nbsp;Opt-In
												</label>
											</div>
										</div>
									</div>
						 ...
						 <div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-lg-9">
									<div class="row">
										<div class="col-md-9">
											<input type="text" class="form-control" name="property_email" value="<?php echo set_value('property_email')?set_value('property_email'):$groupBilling['email']?>" placeholder="Property Email" required>
											<span style="color:red;"><?php echo form_error('property_email'); ?></span>
										</div>
										<div class="col-md-3">
											<div class="checkbox">
												<label class="checkbox-right" >
													<input type="checkbox" name="property_is_email" class="switchery-property-is-email" <?php echo $groupBilling['email_opt_in']==1 ? 'checked' : '' ?>/>&nbsp;Opt-In
												</label>
											</div>
										</div>
									</div>
						...
						<div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-lg-9">
									<div class="row">
										<div class="col-md-9">
											<input type="text" class="form-control" name="secondary_phone" value="<?= $groupBilling['secondary_phone'] ?>" placeholder="Secondary Phone">
											<span>Please do not use dashes</span>
										</div>
									</div>
								</div>
						 ...
						 <div class="col-md-6">
							<div class="form-group">
								...
								<div class="col-lg-9">
									<div class="row">
										<div class="col-md-9">
											<input type="text" class="form-control" name="secondary_email" value="<?php echo set_value('secondary_email') ? set_value('secondary_email') : $groupBilling['secondary_email']?>" placeholder="Secondary Email">
										</div>
									</div>
								</div>
							</div>
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <select class="form-control" name="property_state" id="region">
                                        ...
                                        <optgroup label="Canadian Provinces">
                                          <option value="AB" <?php if ($propertyData['property_state'] == 'AB') {  echo "selected";} ?>>Alberta</option>
                                          <option value="BC" <?php if ($propertyData['property_state'] == 'BC') {  echo "selected";} ?>>British Columbia</option>
                                          <option value="MB" <?php if ($propertyData['property_state'] == 'MB') {  echo "selected";} ?>>Manitoba</option>
                                          <option value="NB" <?php if ($propertyData['property_state'] == 'NB') {  echo "selected";} ?>>New Brunswick</option>
                                          <option value="NF" <?php if ($propertyData['property_state'] == 'NF') {  echo "selected";} ?>>Newfoundland</option>
                                          <option value="NT" <?php if ($propertyData['property_state'] == 'NT') {  echo "selected";} ?>>Northwest Territories</option>
                                          <option value="NS" <?php if ($propertyData['property_state'] == 'NS') {  echo "selected";} ?>>Nova Scotia</option>
                                          <option value="NU" <?php if ($propertyData['property_state'] == 'NU') {  echo "selected";} ?>>Nunavut</option>
                                          <option value="ON" <?php if ($propertyData['property_state'] == 'ON') {  echo "selected";} ?>>Ontario</option>
                                          <option value="PE" <?php if ($propertyData['property_state'] == 'PE') {  echo "selected";} ?>>Prince Edward Island</option>
                                          <option value="QC" <?php if ($propertyData['property_state'] == 'QC') {  echo "selected";} ?>>Quebec</option>
                                          <option value="SK" <?php if ($propertyData['property_state'] == 'SK') {  echo "selected";} ?>>Saskatchewan</option>
                                          <option value="YT" <?php if ($propertyData['property_state'] == 'YT') {  echo "selected";} ?>>Yukon Territory</option>
                                        </optgroup>                                        
                                        <optgroup label="U.S. States/Territories">
                                          <option value="AL" <?php if ($propertyData['property_state'] == 'AL') {  echo "selected";} ?>>Alabama</option>
                                          <option value="AK" <?php if ($propertyData['property_state'] == 'AK') {  echo "selected";} ?>>Alaska</option>
                                          <option value="AZ" <?php if ($propertyData['property_state'] == 'AZ') {  echo "selected";} ?>>Arizona</option>
                                          <option value="AR" <?php if ($propertyData['property_state'] == 'AR') {  echo "selected";} ?>>Arkansas</option>
                                          <option value="CA" <?php if ($propertyData['property_state'] == 'CA') {  echo "selected";} ?>>California</option>
                                          <option value="CO" <?php if ($propertyData['property_state'] == 'CO') {  echo "selected";} ?>>Colorado</option>
                                          <option value="CT" <?php if ($propertyData['property_state'] == 'CT') {  echo "selected";} ?>>Connecticut</option>
                                          <option value="DE" <?php if ($propertyData['property_state'] == 'DE') {  echo "selected";} ?>>Delaware</option>
                                          <option value="DC" <?php if ($propertyData['property_state'] == 'DC') {  echo "selected";} ?>>District Of Columbia</option>
                                          <option value="FL" <?php if ($propertyData['property_state'] == 'FL') {  echo "selected";} ?>>Florida</option>
                                          <option value="GA" <?php if ($propertyData['property_state'] == 'GA') {  echo "selected";} ?>>Georgia</option>
                                          <option value="HI" <?php if ($propertyData['property_state'] == 'HI') {  echo "selected";} ?>>Hawaii</option>
                                          <option value="ID" <?php if ($propertyData['property_state'] == 'ID') {  echo "selected";} ?>>Idaho</option>
                                          <option value="IL" <?php if ($propertyData['property_state'] == 'IL') {  echo "selected";} ?>>Illinois</option>
                                          <option value="IN" <?php if ($propertyData['property_state'] == 'IN') {  echo "selected";} ?>>Indiana</option>
                                          <option value="IA" <?php if ($propertyData['property_state'] == 'IA') {  echo "selected";} ?>>Iowa</option>
                                          <option value="KS" <?php if ($propertyData['property_state'] == 'KS') {  echo "selected";} ?>>Kansas</option>
                                          <option value="KY" <?php if ($propertyData['property_state'] == 'KY') {  echo "selected";} ?>>Kentucky</option>
                                          <option value="LA" <?php if ($propertyData['property_state'] == 'LA') {  echo "selected";} ?>>Louisiana</option>
                                          <option value="ME" <?php if ($propertyData['property_state'] == 'ME') {  echo "selected";} ?>>Maine</option>
                                          <option value="MD" <?php if ($propertyData['property_state'] == 'MD') {  echo "selected";} ?>>Maryland</option>
                                          <option value="MA" <?php if ($propertyData['property_state'] == 'MA') {  echo "selected";} ?>>Massachusetts</option>
                                          <option value="MI" <?php if ($propertyData['property_state'] == 'MI') {  echo "selected";} ?>>Michigan</option>
                                          <option value="MN" <?php if ($propertyData['property_state'] == 'MN') {  echo "selected";} ?>>Minnesota</option>
                                          <option value="MS" <?php if ($propertyData['property_state'] == 'MS') {  echo "selected";} ?>>Mississippi</option>
                                          <option value="MO" <?php if ($propertyData['property_state'] == 'MO') {  echo "selected";} ?>>Missouri</option>
                                          <option value="MT" <?php if ($propertyData['property_state'] == 'MT') {  echo "selected";} ?>>Montana</option>
                                          <option value="NE" <?php if ($propertyData['property_state'] == 'NE') {  echo "selected";} ?>>Nebraska</option>
                                          <option value="NV" <?php if ($propertyData['property_state'] == 'NV') {  echo "selected";} ?>>Nevada</option>
                                          <option value="NH" <?php if ($propertyData['property_state'] == 'NH') {  echo "selected";} ?>>New Hampshire</option>
                                          <option value="NJ" <?php if ($propertyData['property_state'] == 'NJ') {  echo "selected";} ?>>New Jersey</option>
                                          <option value="NM" <?php if ($propertyData['property_state'] == 'NM') {  echo "selected";} ?>>New Mexico</option>
                                          <option value="NY" <?php if ($propertyData['property_state'] == 'NY') {  echo "selected";} ?>>New York</option>
                                          <option value="NC" <?php if ($propertyData['property_state'] == 'NC') {  echo "selected";} ?>>North Carolina</option>
                                          <option value="ND" <?php if ($propertyData['property_state'] == 'ND') {  echo "selected";} ?>>North Dakota</option>
                                          <option value="OH" <?php if ($propertyData['property_state'] == 'OH') {  echo "selected";} ?>>Ohio</option>
                                          <option value="OK" <?php if ($propertyData['property_state'] == 'OK') {  echo "selected";} ?>>Oklahoma</option>
                                          <option value="OR" <?php if ($propertyData['property_state'] == 'OR') {  echo "selected";} ?>>Oregon</option>
                                          <option value="PA" <?php if ($propertyData['property_state'] == 'PA') {  echo "selected";} ?>>Pennsylvania</option>
                                          <option value="RI" <?php if ($propertyData['property_state'] == 'RI') {  echo "selected";} ?>>Rhode Island</option>
                                          <option value="SC" <?php if ($propertyData['property_state'] == 'SC') {  echo "selected";} ?>>South Carolina</option>
                                          <option value="SD" <?php if ($propertyData['property_state'] == 'SD') {  echo "selected";} ?>>South Dakota</option>
                                          <option value="TN" <?php if ($propertyData['property_state'] == 'TN') {  echo "selected";} ?>>Tennessee</option>
                                          <option value="TX" <?php if ($propertyData['property_state'] == 'TX') {  echo "selected";} ?>>Texas</option>
                                          <option value="UT" <?php if ($propertyData['property_state'] == 'UT') {  echo "selected";} ?>>Utah</option>
                                          <option value="VT" <?php if ($propertyData['property_state'] == 'VT') {  echo "selected";} ?>>Vermont</option>
                                          <option value="VA" <?php if ($propertyData['property_state'] == 'VA') {  echo "selected";} ?>>Virginia</option>
                                          <option value="WA" <?php if ($propertyData['property_state'] == 'WA') {  echo "selected";} ?>>Washington</option>
                                          <option value="WV" <?php if ($propertyData['property_state'] == 'WV') {  echo "selected";} ?>>West Virginia</option>
                                          <option value="WI" <?php if ($propertyData['property_state'] == 'WI') {  echo "selected";} ?>>Wisconsin</option>
                                          <option value="WY" <?php if ($propertyData['property_state'] == 'WY') {  echo "selected";} ?>>Wyoming</option>
                                        </optgroup>
                    ...
                    ?>
                                        ...
                                        <option value="<?= $value->property_area_cat_id ?>" <?= $selected; ?>>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <select class="form-control" name="total_yard_grass" id="total_yard_grass">
                                        ...
                                        <option value="Mixed Grass" <?php if ($propertyData['total_yard_grass'] == 'Mixed Grass') {
                            ...
                            <div class="form-group">
                                ...
                                <div class="multi-select-full col-lg-9">
                                    <select class="multiselect-select-all-filtering form-control"
                                        ...
                                        ?>
                                        <option value=<?= $condition->property_condition_id ?> <?=$selectedPC?> ><?= $condition->condition_name ?></option>
                                        <?php }} ?>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="row">
						...
						<div class="col-md-6">	
							<div class="form-group">	
								...
								<div class="multi-select-full col-lg-9">	
									<select class="multiselect-select-all-filtering4 form-control" name="tags[]" multiple="multiple" id="tags_list">	
										<option value="">Select any Tags</option>	
										<?php foreach ($taglist as $value) : ?>	
											<option value="<?= $value->id ?>"<?php if (in_array($value->id, $selected_tag_ids)){ ?> selected <?php } ?>   ><?= $value->tags_title ?> </option>	
										<?php endforeach ?>	
									</select>	
								...
								<div class="multi-select-full col-lg-9  col-sm-10 col-xs-10">
								  <select class=" form-control" name="source"  id="source"  value="<?php echo set_value('source') ?>">
									...
									<?php foreach ($source_list as $value) : ?>
										<option value="<?= $value->source_id ?>" <?php echo  $propertyData['source'] == $value->source_id  ? 'selected' : '' ?>><?= $value->source_name ?></option>
									<?php endforeach ?>
								  </select>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
							<input type="hidden" name="original_progs" id="original_progs" value="<?php echo implode(',', $original_program_ids); ?>">
                                            ...
                                            <div class="col-md-6">
                                                <div id="subscribeTooltip" class="checkbox" data-popup="tooltip-custom"
                                                    ...
                                                    <label class="checkbox-inline checkbox-right">
                                                        <input id="checkbox_<?= $checkboxid ?>" type="checkbox" name="checkbox_<?= $checkboxid ?>" class="switchery_checkbox_<?= $checkboxid ?>"
                                                            <?php if($availableDays[$day]=='true'){echo 'checked';}else{echo '';} ?> >
                                                        <?= $formattedDay ?></label>
                                                </div>
                                            </div>
                                        <?php endforeach; ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6" style="margin: 16px auto">
                            ...
                            <div class="form-group">
                                ...
                                <a href="https://app.measuremaponline.com/" target="_blank" rel="noopener noreferrer"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-9" style="padding-left: 11px;">
                                    ...
                                    <input type="text" data-toggle="tooltip"
                                        ...
                                        class="form-control" name="measure_map_project_id" id="measure_map_project_id"
      ...
      ?>
                ...
                <div id="note-form-wrap" class="collapse">
                  ...
                  <form class="form-horizontal" action="<?= base_url('admin/createNote') ?>" method="post" name="createnoteform" enctype="multipart/form-data" id="createnoteform" onSubmit="formFileSizeValidate(this)">
                      ...
                      <fieldset class="content-group">
                        ...
                        <input type="hidden" name="note_property_id" class="form-control" value="<?= $propertyData['property_id'];?>" >
                        ...
                        <div class="row row-extra-space">
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="form-group checkbox">
                              ...
                              <label class="control-label col-lg-5 text-right">Include in Technician View?</label>
              ...
              <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-xs-4 form-inline text-right" style="padding-left:15px; margin-bottom:15px;">
                ...
                <div class="row">
                  ...
                  <?php if(!empty($property_notes))
                    ...
                    <div class="well property-note" data-note-id="<?= $note->note_id; ?>" data-note-status="<?= (!empty($note->note_assigned_user)) ? $note->note_status : '0'; ?>">
            ...
            <form method="POST"
                ...
                <div style="display: none;" class="form-group">
                    ...
                    <select class="form-control"  id="property" name="property">
                        <option selected value="<?php echo $propertyData['property_id'] ?>"> <?php echo $propertyData['property_title'] ?> </option>
                    </select>
                </div>
                <div class="form-group checkbox">
...
$(document).on("click", "#auto-assign-service-area", () => {
    ...
    polygon_array.forEach(elm => {
        ...
        const propertyInPolygon = google.maps.geometry.poly.containsLocation({lat: <?=$propertyData['property_latitude']?>, lng: <?=$propertyData['property_longitude']?>},poly_draw) ? 1 : 0;
...
<script>
 ...
 function getNoteTypeUpdateServiceSpecificVars(el){
  ...
  function filteringNoteStatus() {
    ...
    Array.from($('.property-note')).forEach((note) => {
