    ...
    <div class="panel panel-flat">
        ...
        <div class="panel-heading">
            <h5 class="panel-title">
                <div class="form-group">
                    <a href="<?= base_url('admin/Estimates/bulkRenewalProgramsList') ?>" id="previous-page-btn"
                       class="btn btn-success"><i class=" icon-arrow-left7"> </i> Back to Program Renewal Select</a>
                </div>
            </h5>
        </div>
        ...
        <div class="panel-body">
            ...
            <form class="form-horizontal"
                  action="<?= base_url('admin/estimates/addBulkRenewalProgramData/') . $programData['program_id'] ?>"
                  method="post" name="addcopyprogram" enctype="multipart/form-data">
                <fieldset class="content-group">
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" class="form-control" name="program_name"
                                           value="<?php echo set_value('program_name') ? set_value('program_name') : $programData['program_name'] ?> - Copy"
                                           placeholder="Program Name">
                                    <span style="color:red;"><?php echo form_error('program_name'); ?></span>
                                    <input type="hidden" class="form-control" name="original_program_name"
                                           value="<?php echo set_value('program_name') ? set_value('program_name') : $programData['program_name'] ?> - Copy">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="col-lg-10" style="padding-left: 5px;">
                                    <select class="form-control" name="program_price_display" disabled>
                                        <option value="1" <?php if ($programData['program_price'] == "1") {
                                            echo "selected";
                                        } ?> >One Time Project Invoicing
                                        </option>
                                        <option value="2" <?php if ($programData['program_price'] == "2") {
                                            echo "selected";
                                        } ?> >Invoiced at Job Completion
                                        </option>
                                ...
                                <input type="hidden" name="program_price" id="program_price"
                                       value="<?= $programData['program_price']; ?>">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class="multi-select-full col-lg-10">
                                    ...
                                    <input type="hidden" name="program_job" id="job_id_order_array"
                                           value="<?= implode(',', $selectedjobid) ?>">
                                    <input type="hidden" name="program_job_original" id="program_job_original"
                                           value="<?= implode(',', $selectedjobid) ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <textarea class="form-control" name="program_notes"
                                              rows="5"><?php echo set_value('program_notes') ? set_value('program_notes') : $programData['program_notes'] ?></textarea>
                        ...
                        <div class="col-md-6">
                            <div class="prioritydivcontainer"
                                 style="display: <?php echo !empty($selecteddata) ? 'block' : 'none'; ?>;">
                                        ...
                                        if (!empty($selecteddata)) {
                                            ...
                                            foreach ($selecteddata as $key => $value) { ?>
                                                <tr id="trid<?= $a ?>">
                                                    ...
                                                    <td class="removeclass" id="<?= $a ?>"
                                                        optionValueRemove="<?= $value->job_id ?>"
                                                        optionTextRemove="<?= $value->job_name ?>">
                                                        <ul class="icons-list">
                    ...
                    <div class="row">
                            ...
                            <div id="invoicetablediv">
                                <div class="table-responsive table-spraye dash-tbl" style="min-height:auto">
                                    ...
                                    <table id="search-inputs" class="table">
                                        <tr>
                                            <td>
                                                <input type="text" class="column_filter form-control" id="col_7_filter"
                                                       data-column="7" placeholder="Zip Code" size="5">
                                            </td>
                                            <td>
                                                <input type="text" class="column_filter form-control" id="col_8_filter"
                                                       data-column="8" placeholder="City">
                                            </td>
                                            <td>
                                                <input type="text" class="column_filter form-control" id="col_5_filter"
                                                       data-column="5" placeholder="Property Type">
                                            </td>
                                            <td>
                                                <input type="text" class="column_filter form-control" id="col_10_filter"
                                                       data-column="10" placeholder="Customer ID">
                                            </td>
                                            <td>
                                                <input type="text" class="column_filter form-control" id="col_4_filter"
                                                       data-column="4" placeholder="Service Area">
                                            </td>
                                            <td>
                                                <input type="text" class="column_filter form-control" id="col_3_filter"
                                                       data-column="3" placeholder="Customer Name">
                                            </td>
                                            <td>
                                                <input type="text" class="column_filter form-control" id="col_9_filter"
                                                       data-column="9" placeholder="Property Status">
                                            </td>
                                        </tr>
                                    </table>
                                            ...
                                            foreach ($selectedpropertylist as $property) {
                                                ...
                                                if (!empty($property->customer_details)) {
                                                    ...
                                                    <tr class="selected-row">
                                                        <td>
                                                            <input type="checkbox" name="property_id"
                                                                   value="<?= $property->property_id; ?>"
                                                                   class="property-selection" checked>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td class="property-services-overrides"
                                                            ...
                                                            foreach ($selecteddata as $key => $value) {
                                                                if (isset($overrideFlag) && $overrideFlag == 1) {
                                                                    ...
                                                                    <input type="number" min="0" step="0.01"
                                                                           name="sor-<?= $property->property_id . '-' . $value->job_id; ?>"
                                                                           value="<?= $override->price_override ?? ''; ?>"
                                                                           class="inpcl form-control service-price-overrides"
                                                                           placeholder="<?= $value->job_name; ?>"
                                                                           data-propertyjob-ids="<?= $property->property_id . '-' . $value->job_id; ?>">
                        ...
                        <textarea name="propertylistarray" id="assign_property_ids2"
                                  style="display:none;"><?= json_encode($keyIds); ?></textarea>
        ...
        <div class="row">
            <div class="form-group col-lg-6">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <button type="submit" class="btn btn-success" id="submit_estimate">Submit & Send<i
                                class="icon-arrow-right14 position-right"></i></button>
                    </div>
                    <?php if ($setting_details->signwell_api_key != "") { ?>
                        <div class="col-lg-4">
                            <button type="submit" class="btn btn-success btn-outline" id="submit_estimate_signwell">
                                Submit & Send to SignWell<i class="icon-arrow-right14 position-right"></i></button>
                        </div>
                    <?php } ?>
                </div>
            </div>
