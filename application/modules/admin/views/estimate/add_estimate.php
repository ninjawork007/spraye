    ...
    <div class="panel-heading">
      <h5 class="panel-title">
        <div class="form-group">
          ...
          <a href="<?= base_url('admin/addCustomer') ?>"  id="save"  class="btn btn-primary"><i class="fa fa-plus"> </i>Add Customer</a>

          <a href="<?= base_url('admin/addProperty') ?>"  id="save"  class="btn btn-primary"><i class="fa fa-plus"> </i>Add Property</a>
              ...
              if(!empty($propertylist)){
                foreach($propertylist as $p){
                  ...
                  <tr>
                    ...
                    <td>
                      <input name="price_override" type="checkbox" value="<?= $p->property_id ?>" class="price_override" disabled />
                    </td>
                    <td>
                      <?= $p->property_zip ?>
                    </td>
                    ...
                    <td style='display: none;'>
                        <input type='hidden' value="<?= $p->source ?>" id="source_<?= $p->property_id ?>" />
                    </td>
                  </tr>
          <?php }
              } else{
      ...
      <div class="row">
        ...
        <div class="form-group col-lg-6">
          <div class="row">
            ...
            <div class="col-lg-4 ">
                <button type="" class="btn btn-success" id="submit_estimate">Submit & Send<i class="icon-arrow-right14 position-right"></i></button>
            </div>
            <?php if($setting_details->signwell_api_key != "") { ?>
                <div class="col-lg-4">
                    <button type="" class="btn btn-success btn-outline" id="submit_estimate_signwell">Submit & Send to SignWell<i class="icon-arrow-right14 position-right"></i></button>
                </div>
            <?php } ?>
          </div>
        </div> 
