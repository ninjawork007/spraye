...
class Ajax_pagination{
    ...
    var $num_links       =  2;
    var $cur_page        =  0;
    var $first_link      = '<i class="fa fa-caret-left"></i>';
    var $next_link       = '&rsaquo;';
    var $prev_link       = '&lsaquo;';
    var $last_link       = '<i class="fa fa-caret-right"></i>';
    var $uri_segment     = 4;
    var $full_tag_open   = '<ul class="pagination pagination-flat pagination-rounded">';
